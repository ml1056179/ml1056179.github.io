(function() {
	...
	(function(e) {
		function a(e, t) {
			var n = t && t.split("index.html"),
				i = r.map,
				s = i && i["*"] || {},
				o, u, a, f, l, c, h;
			if (e && e.charAt(0) === "." && t) {
				n = n.slice(0, n.length - 1), e = n.concat(e.split("index.html"));
			...
			if ((n || s) && i) {
				o = e.split("index.html");
				for (l = o.length; l > 0; l -= 1) {
					u = o.slice(0, l).join("index.html");
					if (n) for (c = n.length; c > 0; c -= 1) {
						a = i[n.slice(0, c).join("index.html")];
						if (a) {
							a = a[u];
							if (a) {
								f = a;
					...
					f = f || s[u];
					if (f) {
						o.splice(0, l, f), e = o.join("index.html");
						break
					}
				}
			}
		...
		function E(e) {
			var t = "",
				n, r, i;
			e.substr(0, 2) === "//" && (e = window.location.protocol + e), i = e.split("index.html");
			for (n = 0, r = i.length; n < r; n++) {
				if (!(n < 3)) break;
				t += i[n], n < 2 && (t += "index.html")
			}
			return t
		}
		function S(e) {
