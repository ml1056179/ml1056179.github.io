...
Modernizr.addTest("retina", function() {
    ...
    function e(e) {
        var i = e || window.event, s = [].slice.call(arguments, 1), l = 0, c = 0, d = 0;
        ...
        var h = 1;
        return a && o && Math.abs(l - Math.round(l)) > 1e-7 && (h *= 120), n && o && (h *= 40), a && r && (h /= 15), 
        l *= h, c *= h, d *= h, s.unshift(e, l, c, d), (t.event.dispatch || t.event.handle).apply(this, s);
    }
    var i = [ "wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll" ], s = "onwheel" in document || document.documentMode >= 9 ? [ "wheel" ] : [ "mousewheel", "DomMouseScroll", "MozMousePixelScroll" ], n = navigator.platform.toUpperCase().indexOf("WIN") >= 0, a = navigator.platform.toUpperCase().indexOf("MAC") >= 0, o = navigator.userAgent.toUpperCase().indexOf("FIREFOX") >= 0, r = navigator.userAgent.toUpperCase().indexOf("OPERA") >= 0;
    if (t.event.fixHooks) for (var l = i.length; l; ) t.event.fixHooks[i[--l]] = t.event.mouseHooks;
    t.event.special.mousewheel = {
        setup: function() {
            if (this.addEventListener) for (var t = s.length; t; ) this.addEventListener(s[--t], e, !1); else this.onmousewheel = e;
        },
        teardown: function() {
            if (this.removeEventListener) for (var t = s.length; t; ) this.removeEventListener(s[--t], e, !1); else this.onmousewheel = null;
        }
    }, t.fn.extend({
    ...
    t.fn.RMDrag = function(e) {
        function i(t) {
            a(t), o.moved = !0;
            var i = t.pageX - o.startX, s = t.pageY - o.startY, r = i - o.deltaX || i, d = s - o.deltaY || s;
            Math.abs(r) > l.X && (r = o.velocityX), Math.abs(d) > l.Y && (d = o.velocityY), o.deltaX = i, o.deltaY = s, 
            o.velocityX = r, o.velocityY = d, n(t), "function" == typeof e.move && e.move.call(c, t), window._moveInProcess = !0;
        }
        function s(l) {
            a(l), o.duration = Number(new Date()) - o.startTime, o.moved && (window.suppressClick = +new Date() + 100), 
            n(l), t(document).off(r.move, i).off(r.end, s), "function" == typeof e.stop && e.stop.call(c, l), window._moveInProcess = !1, 
            e.dragClass && "string" == typeof e.dragClass && d.removeClass(e.dragClass);
        }
        function n(t) {
            for (prop in o) t[prop] = o[prop];
        }
        function a(t) {
        ...
        return this.on(r.start, function(l) {
            a(l), window._moveInProcess || (o = {
                startX: l.pageX,
                startY: l.pageY,
                deltaX: 0,
                deltaY: 0,
                ...
                duration: 0
            }, n(l), t(document).on(r.move, i).on(r.end, s), "function" == typeof e.start && e.start.call(c, l), 
            e.dragClass && "string" == typeof e.dragClass && d.addClass(e.dragClass));
        }), this;
    };
}(jQuery), function(t) {
    t.fn.RMAltText = function(e) {
        var i = [], s = "rmalttext", n = {
            ...
            function a(e) {
                var i = t(e.currentTarget), s = 1e3, n = !1;
                window.rmalt_current_shown && window.rmalt_current_shown !== i && (window.rmalt_current_shown.trigger("rmalt-hide"), 
                s = 0, n = !0), f = setTimeout(r.bind(i[0], n), s);
            }
            function o() {
                clearTimeout(f), clearInterval(v), f = setTimeout(function() {
                    window.rmalt_current_shown = null, m && m.fadeOut(150, function() {
                        m.remove(), m = void 0;
                    });
                }, 400);
            }
            function r(e) {
                var s = e ? 0 : 200;
                if (clearTimeout(f), clearInterval(v), !(i.hasClass("rmalttext-disable") || i.hasClass("active") || i.hasClass("disabled") || i.hasClass("no-hover"))) {
                    if (!m) {
                        (m = t(w).appendTo(p)).find(".rmalttext-content").text(i.attr("data-alt"));
                        var n = i.attr("data-alt-style") || u.cssClass;
                        n && m.addClass(n), m.css({
                            display: "none"
                        }), d();
                    }
                    m.fadeIn(s), window.rmalt_current_shown = i, v = setInterval(function() {
            ...
            function c(t, e) {
                var i, s;
                return "top" == (t = t || u.direction) && (i = e.targetX + (e.targetW - e.tipW) / 2, s = e.targetY - e.offset - e.tipH), 
            ...
            function d() {
                m || this.destroy();
                var t = p[0].getBoundingClientRect(), e = i[0].getBoundingClientRect(), s = i.attr("data-alt-pos") || u.direction, a = {
                    offset: i.attr("data-alt-offset") ? i.attr("data-alt-offset") - 0 : u.offset,
                    tipW: m.outerWidth(!1),
                    tipH: m.outerHeight(!1),
                    targetX: e.left,
                    targetY: e.top,
                    containerX: t.left,
                    containerY: t.top,
                ...
                if (u.keepInBounds && !l(o)) {
                    var r = n[s], d = [ r ].concat(_.without(_.keys(n), s, r));
                    o = c(s = (s = _.find(d, function(t) {
                        return l(c(t, a));
                    })) || "top", a);
                }
                m.addClass("rmalttext-" + s), m.css({
                    left: o.relativeLeft,
                    top: o.relativeTop
                });
            }
            function h() {
                clearTimeout(f), clearInterval(v), window.rmalt_current_shown = null, m && m.remove(), m = void 0;
            }
            var u = {
                direction: "top",
                offset: 9,
            ...
            e && t.extend(u, e);
            var p = u.container && u.container.length ? u.container : t("body");
            if ((!i.hasClass(s) || u.text) && Modernizr.isdesktop) {
                i.addClass(s);
                var g = i.attr("data-alt") || u.text;
                if (g) {
                    var m, f, v, w = '<div class="rmalttext-wrapper">\t\t\t\t\t\t\t\t\t\t<div class="rmalttext-content">' + g + '</div>\t\t\t\t\t\t\t\t\t\t<div class="rmalttext-corner-wrapper"><div class="rmalttext-corner"></div></div>\t\t\t\t\t\t\t\t\t</div>';
                    return u.manual || i.on("mouseenter", a).on("mouseleave", o).on("click", h).on("rmalt-hide", h), i.on("DOMNodeRemovedFromDocument", h), 
                    {
                        hide: h,
                        show: r,
                        update: d,
                        destroy: function() {
                            h(), i.removeClass(s), i.off("mouseenter", a).off("mouseleave", o).off("click", h).off("rmalt-hide", h).off("DOMNodeRemovedFromDocument", h);
                        },
                        getElement: function() {
                            return m;
                        }
    ...
    function i(t) {
        ...
        if (e.defaultView && e.defaultView.getComputedStyle) {
            ...
            if (s) {
                var n = s.getPropertyValue("color").toLowerCase(), a = /\s*rgb\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)\s*/, o = /\s*rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d+|\d*\.\d+)\s*\)\s*/, r = n.match(a) || n.match(o);
                r ? i = {
                    r: r[1] - 0,
                    g: r[2] - 0,
                    b: r[3] - 0,
                    a: void 0 !== r[4] ? r[4] - 0 : 1
                } : (n = n.replace("#", ""), i = {
    ...
    function o(t) {
        ...
        this.playing = !1, this.sound = null, this.click_handler_binded = w(this.click_handler, this), g.push(this);
    }
    function r(t) {
        o.apply(this, Array.prototype.slice.call(arguments)), this.id = t.getAttribute("data-id"), "initialized" !== m && (h.initialize({
            client_id: "5ba7fd66044a60db41a97cb9d924996a"
        }), m = "initialized"), h.stream(this.id, w(function(t) {
            this.destroyed ? t._player.kill && t._player.kill() : (this.sound = t, this.sound._player.on("positionChange", w(function(t) {
    ...
    function l(t) {
        o.apply(this, Array.prototype.slice.call(arguments)), this.id = "soundcite-audio-" + this.generateUUID(), 
        this.url = t.getAttribute("data-url"), this.start = Math.floor(this.start / 1e3), null !== this.end && (this.end = Math.floor(this.end / 1e3)), 
        "initialized" != f && (soundcite.audio_container = e.createElement("div"), a(soundcite.audio_container, "soundcite-audio"), 
        e.getElementsByTagName("body")[0].appendChild(soundcite.audio_container), f = "initialized"), this.audio = e.createElement("audio"), 
        this.audio.id = this.id, this.audio.setAttribute("src", this.url), this.audio.setAttribute("preload", "none"), 
        soundcite.mobile = !0, soundcite.audio_container.appendChild(this.audio), this.sound = u("#" + this.id, {
            frameAnimation: !0
        }), this.sound.on("loadeddata", w(function() {
    ...
    for (var d in t.SOUNDCITE_CONFIG) c[d] = t.SOUNDCITE_CONFIG[d];
    ...
    var h, u, p = e.head || e.getElementsByTagName("head").item(0) || e.documentElement.childNodes[0], g = [], m = "none", f = "none", v = [], _ = [], w = function(t, e) {
    ...
    o.prototype.generateUUID = function() {
    ...
    }, o.prototype.sound_loaded = function() {
        this.el.addEventListener("click", this.click_handler_binded), n(this.el, "soundcite-initializing"), 
        this.el.style.display = "none", this.el.offsetHeight, this.el.style.display = "", a(this.el, "soundcite-loaded soundcite-play");
    }, o.prototype.pause = function() {
        n(this.el, "soundcite-pause"), a(this.el, "soundcite-play"), this.playing = !1, this.pause_sound();
    }, o.prototype.stop = function() {
        n(this.el, "soundcite-pause"), a(this.el, "soundcite-play"), this.playing = !1, this.plays_left = this.plays, 
        this.stop_sound();
    }, o.prototype.track_progress = function() {
        var t = this.end - this.start, e = 100 * (this.sound_position() - this.start) / t;
        this.color || (this.color = i(this.el)), c.update_playing_element(this.el, e, this.color);
    }, o.prototype.click_handler = function(t) {
        t.preventDefault(), function(t) {
            for (var e = 0; e < g.length; e++) g[e].playing && (t && t.el === g[e].el || g[e].pause());
        }(this), this.playing ? this.pause() : this.play();
    }, o.prototype.destroy = function(t) {
        this.destroyed = !0, this.playing && this.pause(), this.el && n(this.el, "soundcite-loaded soundcite-initializing soundcite-loading soundcite-play soundcite-pause"), 
        this.el && this.el.removeEventListener("click", this.click_handler_binded);
    }, (r.prototype = Object.create(o.prototype)).sound_position = function() {
        return this.sound.getCurrentPosition();
    }, r.prototype.pause_sound = function() {
        this.sound.pause();
    }, r.prototype.stop_sound = function() {
        this.sound.stop();
    }, r.prototype.play = function() {
        var t = this.sound_position();
        (t < this.start || t >= this.end) && this.sound.seek(this.start), n(this.el, "soundcite-play"), a(this.el, "soundcite-pause"), 
        this.sound.play(), this.playing = !0, this.prevPos = -1;
    }, r.prototype.destroy = function() {
        this.sound && this.sound._player.kill && this.sound._player.kill(), o.prototype.destroy.apply(this, arguments);
    }, (l.prototype = Object.create(o.prototype)).sound_position = function() {
        ...
        n(this.el, "soundcite-loading soundcite-play"), a(this.el, "soundcite-pause"), this.sound.play(), this.playing = !0, 
        this.sound.on("timeupdate", w(function() {
        ...
        t < this.start || t >= this.end ? (this.sound.on("seeked", w(function() {
            this.sound.off("seeked"), this._play_sound();
        }, this)), this.sound.currentTime(this.start)) : this._play_sound();
    }, l.prototype.play = function() {
        /soundcite\-loading/.test(this.el.className) || (soundcite.mobile ? (n(this.el, "soundcite-play"), a(this.el, "soundcite-loading"), 
        this.startedLoading ? this.play_sound() : (this.sound.on("canplaythrough", w(function() {
            this.play_sound();
        }, this)), e.getElementById(this.id).load()), this.startedLoading = !0) : this.play_sound());
    }, l.prototype.destroy = function() {
        this.sound && u.destroy(this.sound), this.audio && soundcite.audio_container.removeChild(this.audio), 
        o.prototype.destroy.apply(this, arguments);
    }, soundcite.createPlayer = function(n) {
        a(n, "soundcite-initializing"), a(n, "soundcite-force-bg-color"), c.update_playing_element(n, 0, i(n)), 
        n.getAttribute("data-url") && ("none" == f ? (_.push(n), function(i, n) {
            var a, o, r = t.Popcorn;
            if (f = "loading", !r || s(i, r.version) > 0 || n(r, f = "loaded")) {
                var l = e.createElement("script");
                l.type = "text/javascript", l.src = "//d1id5eheivyv24.cloudfront.net/2017-12-15-1c2205f963b4ced2/js/libs/popcorn.min.js", 
                l.onload = l.onreadystatechange = function() {
                    "loading" != f || (a = this.readyState) && "loaded" != a && "complete" != a || (o = t.Popcorn, r && (t.Popcorn = r), 
                    n(o, f = "loaded"), p.removeChild(l));
                }, p.appendChild(l);
            }
        }("1.5.6", function(t) {
            u = t;
            for (var e = 0; e < _.length; e++) new l(_[e]);
        })) : "loading" == f ? _.push(n) : new l(n)), n.getAttribute("data-id") && ("none" == m ? (v.push(n), 
        function(i, n) {
            var a, o = t.SC;
            if (m = "loading", !o || !o.Dialog || s(i, o._version) > 0 || n(o, m = "loaded")) {
                var r = e.createElement("script");
                r.type = "text/javascript", r.src = "//connect.soundcloud.com/sdk-2.0.0.js", r.onload = r.onreadystatechange = function() {
                    "loading" != m || (a = this.readyState) && "loaded" != a && "complete" != a || (n(t.SC, m = "loaded"), 
                    p.removeChild(r));
                }, p.appendChild(r);
            }
        }("2.0.0", function(t) {
            h = t;
            for (var e = 0; e < v.length; e++) new r(v[e]);
        })) : "loading" == m ? v.push(n) : new r(n));
    }, soundcite.destroyPlayer = function(t) {
        for (var e = g.length - 1; e >= 0; e--) g[e].el == t && (g[e].destroy(), g.splice(e, 1));
        for (e = _.length - 1; e >= 0; e--) _[e] == t && _.splice(e, 1);
        for (e = v.length - 1; e >= 0; e--) v[e] == t && v.splice(e, 1);
    }, soundcite.pausePlayer = function(t) {
        for (var e = 0; e < g.length; e++) t == g[e].el && g[e].playing && g[e].pause();
    }, soundcite.setElementsColor = function(t) {
        c.update_playing_element(t, 0, i(t));
    };
    ...
    t.fn.RMScroll = function(e) {
        ...
        i.prototype = {
            ...
            onMouseWheel: function(t, e, i, s) {
                t.preventDefault(), (i || s) && ("vertical" == this.options.tp ? e = s : (e = i || s, t.stopPropagation()));
    ...
    t.constants = _.extend({
        ...
        scanForURIs: function(t, e, i) {
            ...
            return t += " ", t = t.replace(/\b([a-z0-9_\.-]+)@([\da-z\.-]+)\.(biz|com|edu|gov|net|org|us|ru|ua|uk|su|se|co|no|jp|it|in|il|gb|fr|fi|es|de|cz|ch|ca|by|at|au)/gim, function(t) {
                return n++, s[n] = "<a " + (e ? 'class = "' + e + '"' : "") + ' href="mailto:' + t + '">' + t + "</a>", 
                "INNER_TMP_BLOCK_" + n + "_INNER_TMP_BLOCK";
            }), t = t.replace(/\b(https?:\/\/)?([\da-z\.-]+)\.(biz|com|edu|gov|net|org|us|ru|ua|uk|su|se|co|no|jp|it|in|il|gb|fr|fi|es|de|cz|ch|ca|by|at|au)(\/[^\s\(\)\[\]\{\}\<\>]*)*/gim, function(t, a, o, r, l, c) {
                var d = t;
                void 0 != a && "" != a || (d = "http://" + d);
                var h = o;
        ...
        getCurrentTranslate: function(t) {
            ...
            var s;
            return [ (s = (s = (s = i.split("(")[1]).split(")")[0]).split(","))[4] - 0, s[5] - 0 ];
        },
        ...
        loadLoggedUser: function(e) {
            ...
            $(window).on("message", _.bind(function(s) {
                if ((s = s.originalEvent || {}).origin == t.constants.readymag_auth_host) {
        ...
        simulateEvent: function(t, e) {
            ...
            for (var r in n) if (n[r].test(e)) {
                o = r;
                break;
            }
            if (!o) throw new SyntaxError("Only HTMLEvents and MouseEvents interfaces are supported");
            if (document.createEvent) s = document.createEvent(o), "HTMLEvents" == o ? s.initEvent(e, a.bubbles, a.cancelable) : s.initMouseEvent(e, a.bubbles, a.cancelable, document.defaultView, a.button, a.pointerX, a.pointerY, a.pointerX, a.pointerY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, a.button, t), 
            t.dispatchEvent(s); else {
                a.clientX = a.pointerX, a.clientY = a.pointerY;
                s = i(document.createEventObject(), a), t.fireEvent("on" + e, s);
            }
            return t;
        },
    ...
    t.classes.Login = Backbone.View.extend({
        ...
        createAccount: function() {
            var e, i = $.trim(this.$(".join.ljr-panel .fullname-input").val()), s = this.$(".join.ljr-panel .password-input").val(), n = this.$(".join.ljr-panel .email-input").val(), a = [], o = this.$(".join.ljr-panel .go"), r = t.utils.queryUrlGetParam("redirect");
            o.hasClass("processing") || (r && (e = t.utils.queryUrlGetParam("giftCode", decodeURIComponent(r))), 
            "" != i && "" != n && "" != s ? (t.utils.isValidEmail(n) || a.push(this.ERROR_MESSAGES.invalid_email), 
            s.length < 6 && a.push(this.ERROR_MESSAGES.short_password), this.router.analytics && this.router.analytics.sendEvent("Join Button Click", {
                label: "native",
                value: a.length,
                _join_type: "native",
                _errors: a.join(", ")
            }), a.length ? this.showErrors(a) : (this.showButtonPreloader(o), $.ajax({
                type: "POST",
                data: {
                    email: n,
                    name: i,
                ...
                success: _.bind(function(t) {
                    if (this.putStorageData("native"), r) return window.location.href = r;
                    this.redirectAfterJoin(t.uri, o);
                }, this),
                error: _.bind(function(e) {
                    if (this.hideButtonPreloader(o), console.log(e), 403 == e.status) return alert("User with email " + n + " exists. Forgot password?");
    ...
    t.textutils = {
        ...
        generateStylesStr: function(e) {
            function i(t) {
                var e = r[d + t];
                return "inherit" == e && d && (e = r[t]), e;
            }
            function s(t) {
                return t + (/px/i.test(t) ? "" : "px");
            }
            var n, a, o = "", r = e.style, l = e.indentation ? "\t" : "", c = ";" + (e.lineBreaks ? "\n" : ""), d = e.attrPrefix || "";
            return "paragraph" == e.tp && (o += l + "font-family: " + i("font-family") + c, o += l + "font-style: " + i("font-style") + c, 
            o += l + "font-weight: " + i("font-weight") + c, o += l + "font-size: " + s(i("font-size")) + c, o += l + "letter-spacing: " + s(i("letter-spacing")) + c, 
            o += l + "line-height: " + s(i("line-height")) + c, o += l + "text-align: " + i("text-align") + c, o += l + "text-decoration: " + i("text-decoration") + c, 
            o += l + "text-transform: " + i("text-transform") + c, o += l + "color: " + t.utils.getRGBA(i("color"), i("opacity") / 100) + c, 
            o += l + "padding-top: " + s(i("padding-top")) + c, o += l + "padding-right: " + s(i("padding-right")) + c, 
            o += l + "padding-bottom: " + s(i("padding-bottom")) + c, o += l + "padding-left: " + s(i("padding-left")) + c), 
            "link" == e.tp && (o += l + "text-decoration: none" + c, o += l + "color: " + t.utils.getRGBA(i("color"), i("opacity") / 100) + c, 
            "none" != i("u-style") ? (n = t.utils.getRGBA(i("u-color"), i("u-opacity") / 100), a = parseInt(i("u-size"), 10), 
            offset = parseInt(i("u-offset"), 10) + a, o += l + "padding-bottom: " + s(Math.max(offset, 0)) + c, 
            "solid" == i("u-style") && (o += l + "background: linear-gradient(to right, " + n + " 0%, " + n + " 100%)" + c, 
            o += l + "background-size: 1px " + s(a) + c), "dotted" == i("u-style") && (o += l + "background: linear-gradient(to right, " + n + " 0%, " + n + " 50%, transparent 50%,transparent 100%)" + c, 
            o += l + "background-size: " + s(2 * a) + " " + s(a) + c), "dashed" == i("u-style") && (o += l + "background: linear-gradient(to right, " + n + " 0%, " + n + " 66.6666%, transparent 66.6666%,transparent 100%)" + c, 
            o += l + "background-size: " + s(3 * a) + " " + s(a) + c), offset < 0 ? o += l + "background-position: 0 " + (100 + offset) + "%" + c : o += l + "background-position: 0 100%" + c, 
            o += l + "background-repeat: repeat-x" + c) : o += l + "background: none" + c), o;
        },
        ...
        appendFontsCssToDocument: function(e, i) {
                ...
                if ("webtype" == s && (i = {
                    ...
                    o && o.css_url && (i = {
                        ...
                        data: {
                            css_name: t.css_name,
                            css_url: o.css_url,
                            signed_css_url: o.signed_css_url
                        }
                    });
                }
                "typekit" == s && (i = {
            ...
            var d = t.screenshot && "true" == t.utils.queryUrlGetParam("pdf");
            d && this.loadTypekitSubstitutionFonts(r.typekit);
            var h = _.has(r, "custom");
            _.each(r, function(n, a) {
                var o, r, l, c, h, u = "custom" == a ? 1 : "google" == a ? 22 : n.length, p = Math.ceil(n.length / u), g = 0, m = function() {
                    function p(e) {
                        e.addClass("fonts").attr("data-id", t.utils.generateUUID()).attr("data-provider", a).attr("data-fonts-and-variations", fontsAndVariations.join("||"));
                    }
                    if (r = o * u, l = Math.min((o + 1) * u, n.length), c = n.slice(r, l), h = _.pluck(c, "data"), fontsAndVariations = _.pluck(c, "fontAndVariations"), 
                    $("link, style").addClass("existing"), "google" == a && (w = (t.constants.IS_FILE_PROTOCOL ? "http://" : "//") + "fonts.googleapis.com/css?family=", 
                    f = h.join("%7C"), s(w + f + (v = "&subset=latin,vietnamese,khmer,cyrillic-ext,greek-ext,greek,devanagari,latin-ext,cyrillic"))), 
                    "typekit" == a && !Modernizr.isboxversion) {
                        if ("edit" == e.version && !d) try {
                            window.TypekitPreview && window.TypekitPreview.load(h);
                        } catch (t) {}
                            ...
                            try {
                                Typekit.load({
                                    active: function() {
                                        ...
                                        t.addClass("typekit-kit"), p(t);
                                    }
                                });
                            } catch (t) {}
                        }));
                    }
                    "webtype" == a && (w = t.common.isDownloadedSource ? t.constants.readymag_host : "", $('link.fonts[data-provider="webtype"]').length || (y = window.ServerData && window.ServerData.fonts && window.ServerData.fonts.webtype, 
                    s(w + y))), "typetoday" != a || d || (w = t.common.isDownloadedSource ? t.constants.readymag_host : "", 
                    $('link.fonts[data-provider="typetoday"]').length || (y = window.ServerData && window.ServerData.fonts && window.ServerData.fonts.typetoday, 
                    s(w + y))), "custom" == a && (b = h[0].signed_css_url || h[0].css_url, /^\/api\/fonts\//i.test(b) ? function() {
                        var t = $("<style>").attr("type", "text/css");
                        $("head").append(t), $.get(b, function(e) {
                            t.text(e), ++g >= n.length && _.isFunction(i) && i();
                        });
                    }() : s(b)), p($("link:not(.existing), style:not(.existing)")), $("link, style").removeClass("existing");
                };
                for (o = 0; o < p; o++) {
                    var f, v, w, y, b;
                    m();
        ...
        appendFontsCssToIFrame: function(t) {
            ...
            i.each(function() {
                ...
                var t = $(this);
                s[t.attr("data-id")] || t.clone().appendTo(n);
            });
        },
        ...
        exactWaitForFontLoad: function(t, s, n, a) {
            function o() {
                var v = +new Date() - f > i, _ = function() {
                    var t = r;
                    p.clearRect(0, 0, c, d), g || (g = u.toDataURL("image/png"), t = l);
                    p.font = t, p.fillStyle = "000", p.fillText("a1-&q", 0, 20);
                    var e = u.toDataURL("image/png");
                    m || (m = e);
                    return e != g && e != m;
                }();
                if (_ || v) return p = void 0, h.remove(), void a(_, t, s, n);
                setTimeout(o, e);
            }
            var r = n + " " + s + " 12px " + t + ", Arial", l = n + " " + s + " 12px Arial", c = 20, d = 20, h = $('<canvas width="' + c + '" height="' + d + '"></canvas>'), u = h[0], p = u.getContext("2d"), g = "", m = "", f = +new Date();
            h.appendTo("body").css({
                position: "absolute",
                left: 0,
                top: "-999px"
        ...
        getUsedFontsFromWidgetsModels: function(e) {
            ...
            for (var s = {}, n = {}, a = {}, o = {}, r = e.models, l = 0; l < r.length; l++) {
                var c = r[l];
                if ("slideshow" == i(c, "type") && i(c, "text_style")) {
                    var d = i(c, "text_style");
                    d["font-family"] && d["font-weight"] && d["font-style"] && (n[d["font-family"] + "|" + d["font-style"] + "|" + d["font-weight"]] = 1);
                }
                if ("button" == i(c, "type") && i(c, "font-family") && i(c, "font-weight") && i(c, "font-style") && (a[i(c, "font-family") + "|" + i(c, "font-style") + "|" + i(c, "font-weight")] = 1), 
                "form" == i(c, "type")) {
                    var h = i(c, "style-" + i(c, "style") + "-fields"), u = _.clone(i(c, "style-" + i(c, "style") + "-button-default"));
                    for (_.isEmpty(u) || (u["font-family"] = "inherit" == u["font-family"] ? h["font-family"] : u["font-family"], 
                    u["font-style"] = "inherit" == u["font-style"] ? h["font-style"] : u["font-style"], u["font-weight"] = "inherit" == u["font-weight"] ? h["font-weight"] : u["font-weight"]), 
                    o[h["font-family"] + "|" + h["font-style"] + "|" + h["font-weight"]] = 1, u && (o[u["font-family"] + "|" + u["font-style"] + "|" + u["font-weight"]] = 1), 
                    j = 0; j < t.viewports.length; j++) {
                        var p = c["viewport_" + t.viewports[j].name];
                        p && (h = p["style-" + p.style + "-fields"], u = _.clone(p["style-" + p.style + "-button-default"]), 
                        _.isEmpty(u) || (u["font-family"] = "inherit" == u["font-family"] ? h["font-family"] : u["font-family"], 
                        u["font-style"] = "inherit" == u["font-style"] ? h["font-style"] : u["font-style"], u["font-weight"] = "inherit" == u["font-weight"] ? h["font-weight"] : u["font-weight"]), 
                        h && (o[h["font-family"] + "|" + h["font-style"] + "|" + h["font-weight"]] = 1), u && (o[u["font-family"] + "|" + u["font-style"] + "|" + u["font-weight"]] = 1));
                    }
                }
                "text" == i(c, "type") && i(c, "text") && _.extend(s, this.scanTextForFontsAndVariationsRaw(i(c, "text"), i(c, "version"), e.excludeUnusedDefault)), 
                "hotspot" == i(c, "type") && _.each(this.getHotspotTextModels(c), _.bind(function(t) {
                    var n = i(t, "text");
                    n && _.extend(s, this.scanTextForFontsAndVariationsRaw(n, i(t, "version"), e.excludeUnusedDefault));
                }, this));
            }
            var g = _.extend({}, s, n, a, o), m = {};
            _.each(g, function(t, e) {
                var i = e.split("|"), s = i[0], n = i[1].toLowerCase(), a = i[2].toLowerCase();
                m[s] = m[s] || [], m[s].push(("italic" == n ? "i" : "n") + Math.floor(a / 100));
            });
            var f, v = [], w = this;
            return _.each(m, function(i, s) {
                (f = _.findWhere(t.textutils.fontsShortList.webtype, {
                    name: s
                })) ? v.push({
                    provider: "webtype",
                    css_name: f.name,
                    ...
                    used_variations: w.calcBrowserUsedVariation(i, f.variations)
                }) : (f = _.findWhere(t.textutils.fontsShortList.typetoday, {
                    name: s
                })) ? v.push({
                    provider: "typetoday",
                    css_name: f.name,
                    ...
                    variations: f.variations,
                    used_variations: w.calcBrowserUsedVariation(i, f.variations)
                }) : (f = _.findWhere(t.textutils.fontsShortList.google, {
                    family: s
                })) ? v.push({
                    provider: "google",
                    css_name: f.family,
                    ...
                    variations: f.variations,
                    used_variations: w.calcBrowserUsedVariation(i, f.variations)
                }) : (f = _.findWhere(t.textutils.fontsShortList.typekit, {
                    id: s
                })) ? v.push({
                    provider: "typekit",
                    css_name: f.id,
                    ...
                    variations: f.variations,
                    used_variations: w.calcBrowserUsedVariation(i, f.variations)
                }) : e.includeCustom && (f = _.findWhere(e.customList, {
                    css_name: s
                })) && v.push({
                    provider: "custom",
                    css_name: f.css_name,
        ...
        getUsedParagraphStylesFromWidgetsModels: function(e) {
            ...
            var s, n, a = "";
            for (s = 0; s < e.length; s++) "text" == i(n = e[s], "type") && i(n, "text") && (a += i(n, "text")), 
            "hotspot" == i(n, "type") && _.each(this.getHotspotTextModels(n), _.bind(function(t) {
                a += i(t, "text") || "";
            }, this));
            var o = [], r = t.constructorRouter.workspace.mag.edit_params.get("paragraph_styles");
            if (a) for (s = 0; s < r.length; s++) {
                var l = r[s];
                a.indexOf(l._name) >= 0 && o.push(l);
            }
            return o;
        },
        getUsedLinkStylesFromWidgetsModels: function(e) {
            ...
            var o = [], r = t.constructorRouter.workspace.mag.edit_params.get("link_styles");
            if (a) for (s = 0; s < r.length; s++) {
                var l = r[s];
                a.indexOf(l._name) >= 0 && o.push(l);
            }
        ...
        scanTextForFontsAndVariationsRaw: function(e, i, s) {
            var n, a, o, r, l, c, d, h, u, p, g, m = {}, f = {}, v = [], w = document.defaultView.getComputedStyle;
            for (n = 0; n < t.viewports.length; n++) e.split("-" + t.viewports[n].name).length > 1 && v.push(t.viewports[n].name);
            (o = $(".used-fonts-test")).length || (o = $("<div>").addClass("used-fonts-test").css({
                position: "absolute",
                display: "none !important",
                left: -9999,
                width: 999
            }).appendTo("body")), o.removeClass("v1 v2").addClass("v" + (i || 1)), (a = o[0]).innerHTML = e, d = (c = a.querySelectorAll("span,p,a")).length;
            var y = (l = w(a, null)).fontFamily + "|" + l.fontStyle + "|" + l.fontWeight;
            m[y] = 1;
            var b, k = !1, x = function(t) {
                return -1 !== _.findIndex(t.childNodes, function(t) {
                    return t.nodeType === Node.TEXT_NODE && t.textContent.replace(/\r?\n/g, "").length;
                });
            }, P = _.filter(c, x);
            for (r = 0; r < P.length; r++) b = (l = w(P[r], null)).fontFamily + "|" + l.fontStyle + "|" + l.fontWeight, 
            k = k || b === y, m[l.fontFamily + "|" + l.fontStyle + "|" + l.fontWeight] = 1;
            var T = x(a);
            for (!s || k || T || delete m[y], n = 0; n < v.length; n++) if ("default" != (p = v[n])) {
                for (r = 0; r < d; r++) (h = (g = c[r]).getAttribute("data-style-" + p)) && ("empty" == h ? g.removeAttribute("style") : g.setAttribute("style", h)), 
                (u = g.getAttribute("data-class-" + p)) && ("empty" == u ? g.removeAttribute("class") : g.setAttribute("class", u)), 
                (g.getAttribute("style") || g.getAttribute("class")) && (m[(l = w(g, null)).fontFamily + "|" + l.fontStyle + "|" + l.fontWeight] = 1);
                n < v.length - 1 && (a.innerHTML = e, d = (c = a.querySelectorAll("span,p,a")).length);
            }
            return _.each(m, function(t, e) {
                var i = e.split("|"), s = i[0], n = i[1].toLowerCase(), a = i[2].toLowerCase();
    ...
    t.classes.extendAnalyticsPublic = {
        initialize: function(e) {
            ...
            this.lastTrackedUrl = "", this.shortlink_redirect = t.utils.getCookie("shortlink_redirect"), $(_.bind(function() {
                this.trackPage();
            }, this));
        },
        sendEvent: function(e, i, s, n) {
            if (window.ga) {
                ...
                return t.common.readymagTracker && (r.dimension1 = o.dims.magId, r.dimension2 = o.dims.magCreatorId, 
                r.dimension3 = o.dims.pageType), window.ga("readymag.send", r), t.common.userTracker && "Project Actions" == o.category && window.ga("t0.send", r), 
                r;
            }
        },
        trackPage: function(e) {
            if (window.ga) {
                ...
                if (void 0 != this.shortlink_redirect && (i = _.extend(i, this._processRedirectUTM())), i.page != this.lastTrackedUrl) {
                    ...
                    return t.common.readymagTracker && (s.dimension1 = i.dims.magId, s.dimension2 = i.dims.magCreatorId, 
                    s.dimension3 = i.dims.pageType, s.metric1 = i.countProjectView), window.ga("readymag.send", "pageview", s), 
                    t.common.userTracker && window.ga("t0.send", "pageview", s), s;
                }
            }
        },
        _extendParams: function(e) {
            ...
            i.page || t.common.isDownloadedSource ? !i.page && t.common.isDownloadedSource && (i.page = Backbone.history.location.pathname) : i.page = "/" + Backbone.history.getFragment(), 
        ...
        _parseDimensions: function(t) {
            return {
                magId: t.magId || e,
                magCreatorId: t.magCreatorId || i,
                pageType: t.pageType || s,
                userId: t.userId || n
            };
        },
    ...
    t.viewports = [ {
        ...
        shortcut: "3"
    } ], t.viewport_fields_common = [ "x", "y", "w", "h", "z", "hidden", "angle", "flip_h", "flip_v", "pack_id", "fixed_position", "is_full_width", "sticked", "animation" ], 
    t.viewport_fields = {
        background: _.union([ "color", "opacity", "selectedType", "picture" ], t.viewport_fields_common),
        picture: _.union([ "picture", "cropW", "cropH", "cropX", "cropY", "originalW", "originalH", "ratio", "scale", "pic_opacity", "pic_color", "border_size", "border_color", "border_radius", "border_radius_max", "opacity", "anchor_link_pos" ], t.viewport_fields_common),
        slideshow: _.union([ "images_h", "captions_h" ], t.viewport_fields_common),
        text: _.union([ "column_count", "column_gap", "bg_color", "bg_opacity" ], t.viewport_fields_common),
        shape: _.union([ "rasterUrl", "raster2xUrl", "borders", "weight", "anchor_link_pos", "bg_color" ], t.viewport_fields_common),
        button: _.union([ "anchor_link_pos" ], t.viewport_fields_common),
        hotspot: _.chain().union([ "borders", "weight", "anchor_link_pos" ], t.viewport_fields_common).without("w", "h").value(),
        form: _.union([ "layout", "style", "style-colored-button-default", "style-colored-button-hover", "style-colored-fields", "style-outlined-button-default", "style-outlined-button-hover", "style-outlined-fields", "style-underlined-button-default", "style-underlined-button-hover", "style-underlined-fields" ], t.viewport_fields_common)
    }, t.viewport_listall = _.map(t.viewports, function(t) {
        return "viewport_" + t.name;
    }), t.viewport_list = _.without(t.viewport_listall, "viewport_default"), t.widgetViewportFields = function(e) {
        return t.viewport_fields[e] || t.viewport_fields_common;
    };
}(RM);
...
"undefined" == typeof RM && (RM = {}), function(t) {
        ...
        initFacebookAPI: function(e) {
            ...
            if ("function" == typeof e) {
                ...
                window.fbAsyncInit = function() {
                    ...
                    var n, a = e.getElementsByTagName("script")[0];
                    e.getElementById("facebook-jssdk") || ((n = e.createElement("script")).id = "facebook-jssdk", n.src = t.utils.selectProtocol("//connect.facebook.net/en_US/sdk.js"), 
    ...
    t.classes.embedplugins = t.classes.embedplugins || {}, t.embedutils = t.embedutils || {}, t.embedutils.findPlugin = function(e) {
        ...
        initialize: function(e) {
            t.classes.EmbedPlugin.prototype.initialize.apply(this, arguments), this.block && this.block.frame && (_.extend(this.block.frame, {
                ...
                w: Math.max(this.block.model.get("w"), this.block.frame.minwidth),
                h: Math.max(this.block.model.get("h"), this.block.frame.minheight)
            }));
        },
        parse: function(t, e) {
            return e(t.replace(/<script.*script>/i, ""));
        ...
        draw: function(e, i, s) {
            i.html(e), t.embedutils.initReadymag(function() {
                window.RM_EMBED_parse(function() {
                    var t = i.find(this.containerSelector).height();
                    s(null, t);
                }.bind(this));
            }.bind(this));
        }
        ...
        parse: function(t, e) {
            var i;
            return i = t.match(/[\s\S]*?(\<iframe[\s\S]*?\>)[\s\S]*?(\<\/iframe\>)[\s\S]*?/i), e(i && i[1] && i[2] ? i[1] + i[2] : null);
        },
        sanitize: function(t) {
            var e = $(t);
        ...
        setPosterInsteadOfVideo: function(t, e, i, s) {
            function n(e) {
                d[0].src = e, i.css({
                    ...
                    width: "100%",
                    height: "auto"
                }), i.append(d), d.on("load", function() {
                    "youtube" === t && !c && d[0].naturalWidth <= 120 ? (c = !0, e = "https://img.youtube.com/vi/" + a + "/hqdefault.jpg", 
                    d[0].src = e) : (s(), d.off("load"));
                });
            }
            var a, o, r, l = "", c = !1, d = $("<img/>");
            if ("youtube" === t) {
                if (o = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/, !(r = e.match(o)) || !r[7] || 11 != r[7].length) return void s();
                a = r[7], n(l = "https://img.youtube.com/vi/" + a + "/sddefault.jpg");
            } else if ("vimeo" === t) {
                if (o = /player\.vimeo\.com\/video\/([0-9]*)/, !(r = e.match(o)) || !r[1]) return void s();
                a = r[1], $.getJSON("https://www.vimeo.com/api/v2/video/" + a + ".json?callback=?", {
                    format: "jsonp"
                }).done(function(t) {
                    n(l = t[0].thumbnail_large);
                }).fail(function() {
                    s();
                });
            }
        ...
        draw: function(t, e, i) {
            ...
            if (!this.isInViewer || this.block && this.block.model.get("use_iframe") || this.widget && this.widget.use_iframe) {
                a.each(function() {
                    s += this.outerHTML;
                }), s += '<script src="//d1id5eheivyv24.cloudfront.net/2017-12-15-1c2205f963b4ced2/js/vendor/jquery-2.2.3.min.js"><\/script>', 
                s += "</head>", r.html(t), n += r[0].innerHTML + "</body>";
        ...
        loadNodeWithScripts: function(t, e, i) {
            function s() {
                var e, n, a, r = o[l];
                return r ? (l++, e = document.createElement("script"), r.src && (e.src = r.src), r.text && (e.text = r.text), 
                r.src ? void (r.src && (e.onload = function() {
                    clearInterval(n), s();
                }, a = 0, n = setInterval(function() {
                    ++a > 10 && (e.onload = null, s());
                }, 1e3), t[0].appendChild(e))) : (t[0].appendChild(e), s())) : i();
            }
            var n, a = $('<div id="fake"></div>'), o = [];
            a.html(e), (n = a.find("script")).each(function() {
                this.src && this.text ? (o.push({
                    src: this.src
                }), o.push({
                    text: this.text
                })) : o.push({
            ...
            var r = _.find(o, function(t) {
                return !!t.src;
            });
            if (!o.length || !r || o < 2) t.html(a[0].innerHTML); else {
                n.remove();
                var l = 0;
                t.html(a[0].innerHTML), s();
            }
        }
    });
}(RM), function() {
    ...
    var i = {
        ...
        matchCode: function(t, i) {
            ...
            for (var s in this.matchers) {
                ...
                for (var a in n) if (a = n[a], e.isFunction(a)) {
                    if (a(t, i)) return s;
                } else {
                    if (new RegExp(a.source, a.flags).test(t)) return s;
                }
            }
    ...
    getVideoAspectFromPoster: function(t, e) {
        ...
        return d.onload = function() {
            function t(t, e) {
                var i, s, n, a, l, c = "row" == e ? o : r, d = 0, h = 0;
                for (i = 0; i < c; i++) s = ("row" == e ? t * o + i : i * o + t) << 2, d += (n = u.data[s]) + (a = u.data[s + 1]) + (l = u.data[s + 2]), 
                n < 20 && a < 20 && l < 20 && h++;
                return d /= 3 * c, {
                    isBlack: d < 5 && c - h < 3,
                    isContrast: h < c / 2
            ...
            var i, h, u = a.getImageData(0, 0, o, r), p = 0, g = 0, m = 0, f = 0;
            for (h = 0; h <= r / 2; h++) {
                if (t(h, "row").isContrast) {
                    (h <= 1 || t(h - 1, "row").isBlack || t(h - 2, "row").isBlack) && (p = h);
                    break;
                }
            }
            for (h = r - 1; h > r / 2; h--) {
                if (t(h, "row").isContrast) {
                    (h >= r - 2 || t(h + 1, "row").isBlack || t(h + 2, "row").isBlack) && (g = r - 1 - h);
                    break;
                }
            }
            var v = Math.max(p, g), _ = 0;
            if (!v) {
                for (i = 0; i <= o / 2; i++) {
                    if (t(i, "column").isContrast) {
                        (i <= 1 || t(i - 1, "column").isBlack || t(i - 2, "column").isBlack) && (m = i);
                        break;
                    }
                }
                for (i = o - 1; i > o / 2; i--) {
                    if (t(i, "column").isContrast) {
                        (i >= o - 2 || t(i + 1, "column").isBlack || t(i + 2, "column").isBlack) && (f = o - 1 - i);
                        break;
                    }
                }
                _ = Math.max(f, m);
            ...
            v > r / 3 && (v = 0), _ > o / 3 && (_ = 0);
            var w = l / c;
            v ? w = o / (r - 2 * v) : _ && (w = (o - 2 * _) / r), n.remove(), s.aspect_poster = l / c, s.aspect_real = w, 
            e(s);
        }, d.onerror = function() {
            e(s);
    ...
    setVideoPosition: function(t) {
        if (t.aspect_poster && t.$media && t.$media.length) {
            ...
            var n = t.aspect_poster, a = t.aspect_real || n, o = t.controls_remove ? 5 : 0, r = e + 2 * o, l = i + 2 * o, c = r, d = l;
            if (n) {
                var h, u;
                r / l > a ? u = (h = r) / a : h = (u = l) * a, n < a ? d = (c = h) / n : c = (d = u) * n;
            }
            if ("vimeo" == t.provider.toLowerCase() && t.controls_remove) {
                var p = (d - l) / 2, g = (c - r) / 2;
                if (_ = 50, minRightPadding = 46, diffBottom = _ - p, diffRight = minRightPadding - g, diffBottom > 0 || diffRight > 0) {
                    var m = (d + 2 * diffBottom) / d, f = (c + 2 * diffRight) / c, v = Math.max(m, f);
                    c *= v, d *= v;
                }
            }
            if ("youtube" == t.provider.toLowerCase() && t.controls_remove) {
                var _ = 103, w = _ - (p = (d - l) / 2);
                w > 0 && (c = (d += 2 * w) * n);
            }
            var y = -o - (c - r) / 2, b = -o - (d - l) / 2;
            t.$media.css({
                left: y,
                top: b,
                width: c,
    ...
    t.animationutils = {
        ...
        getNormalizedAnimation: function(e, i, s, n) {
            ...
            for (var l = {
                ...
                1 != n && i && (d.dx *= n, d.dy *= n), "scroll" == r.type ? (d.calcedDuration = function(t, e) {
                    var i, s = t.dx - e.dx, n = t.dy - e.dy;
                    return i = 0 != s || 0 != n ? Math.pow(s * s + n * n, .5) / t.speed : 300 / t.speed, Math.ceil(i);
                }(d, l), d.calcedDelay = d.delay_px ? d.delay_px * t.scale.normalize(n) : 0) : (d.calcedDuration = d.duration || .001, 
        ...
        canBeExternalTrigger: function(t, e) {
            var i = t.attributes || t.model && t.model.attributes || {}, s = e.attributes || e.model && e.model.attributes || {};
            return i.type && -1 === this.EXTERNAL_TRIGGER_BLOCK_EXCLUDE.indexOf(i.type) && !(e && s.is_above && i.is_global && !i.is_above);
        },
    ...
    var e = 0, i = t.animationutils.ANIMATION_PROPERTIES, s = Backbone.View.extend({
        ...
        generateNormalAnimation: function() {
            function t(t, e, s) {
                ...
                return n += _.map(t, function(t) {
                    return 100 * t + "%";
                }).join(", ") + " {", n += i.transformCSS + ": " + a.getTransformString(e.dx, e.dy, e.rotate, e.scale / 100) + "; ", 
                n += "opacity: " + (0 == e.opacity ? 0 : e.opacity / 100) + "; ", s && (n += i.animationTimingFunctionCSS + ": " + s), 
                n += "}\n";
            }
            for (var s = 0, n = [ [ 0 ] ], a = this, o = this.steps.length, r = 0; r < o; r++) {
                var l = this.steps[r].calcedDelay / this.animationLength, c = this.steps[r].calcedDuration / this.animationLength;
                l >= 1e-4 ? n[n.length - 1].push(s + l) : l = 0, s += l + c, r == o - 1 && (s = 1), n.push([ s ]);
            }
            e++, this.id = e;
            var d = i.keyframeCSS + " animation_" + this.id + " {\n", h = {
                none: "linear",
                "ease-in": "ease-in",
                "ease-out": "ease-out",
            ...
            }, h[this.steps[0].acceleration]);
            for (r = 0; r < o; r++) d += t(n[r + 1], this.steps[r], this.steps[r + 1] ? h[this.steps[r + 1].acceleration] : void 0);
            d += "}\n", this.keyframesStyle = document.createElement("style"), this.keyframesStyle.innerHTML = d, 
            this.$el.append(this.keyframesStyle), this.$el.on(i.animationIterationJS, this.onAnimationIteration), 
            this.$el.on(i.animationEndJS, this.onAnimationEnd), this.applyStepState(this.screenshotMode && "load" == this.type ? o - 1 : "initial");
        },
        ...
        applyStepState: function(t) {
            ...
            var e;
            if ("initial" == t) this.$el[0].style[i.transformJS] = this.getTransformString(0, 0, this.steps[0].from_rotate, this.steps[0].from_scale / 100), 
        ...
        onAnimationIteration: function(e) {
            if (this.loop === t.animationutils.LOOP_TYPES.swing) {
                Math.round(e.originalEvent.elapsedTime / this.animationLength) % 2 ? this.reversed = !0 : (this.reversed = !1, 
                this.trigger("full-cycle-end"));
            } else this.trigger("full-cycle-end");
        },
        resume: function() {
        ...
        seek: function(t) {
            function e(t, e, i, n) {
                ...
                var a = i / (n - 1);
                return {
                    dx: t.dx == e.dx ? t.dx : s(t.dx, e.dx, a, e.acceleration),
                    dy: t.dy == e.dy ? t.dy : s(t.dy, e.dy, a, e.acceleration),
                    opacity: t.opacity == e.opacity ? t.opacity : s(t.opacity, e.opacity, a, e.acceleration),
                    rotate: t.rotate == e.rotate ? t.rotate : s(t.rotate, e.rotate, a, e.acceleration),
                    scale: t.scale == e.scale ? t.scale : s(t.scale, e.scale, a, e.acceleration)
                };
            }
            function s(t, e, i, s) {
                var n;
                return n = s && "none" != s ? "ease-in" == s ? i * i : "ease-out" == s ? i * (2 - i) : i < .5 ? i * i * 2 : 2 * i * (2 - i) - 1 : i, 
                t + (e - t) * n;
            }
            if (i.animationSupported) {
                t = Math.max(Math.min(t, this.animationLength), 0);
                var n, a = this.frames.length;
                for (n = 0; n < a && !(this.frames[n].ind > t); n++) ;
                n--;
                var o, r, l;
                this.frames[n].isDelay ? o = e(this.frames[n].params, this.frames[n].params, 0, 1) : (r = n ? this.frames[n].ind - 1 : 0, 
                l = n == a - 1 ? this.animationLength : this.frames[n + 1].ind - 1, o = e(this.frames[n ? n - 1 : 0].params, this.frames[n].params, t - r, l - r + 1)), 
                this.$el[0].style[i.transformJS] = this.getTransformString(o.dx, o.dy, o.rotate, o.scale / 100), this.$el[0].style.opacity = 0 == o.opacity ? 0 : o.opacity / 100, 
                this.$el.toggleClass("invisible", 0 == o.opacity);
            }
        },
        destroy: function() {
    ...
    t.buttonutils = {
        ...
        generateStylesStr: function(e) {
            function i(t) {
                var e = a[l + t];
                return ("inherit" === e && l || void 0 === e) && (e = a[t]), "border-color" === t && "hover-" === l ? 0 == a["hover-border-width"] && (e = a["border-color"]) : "border-color" === t && 0 == a["border-width"] && (e = a["hover-border-color"]), 
                "border-color-opacity" === t && "hover-" === l ? 0 == a["hover-border-width"] && (e = a["border-color-opacity"]) : "border-color-opacity" === t && 0 == a["border-width"] && (e = a["hover-border-color-opacity"]), 
                e;
            }
            function s(t) {
                return t + (/px/i.test(t) ? "" : "px");
            }
            var n = "", a = e.model, o = e.indentation ? "\t" : "", r = ";" + (e.lineBreaks ? "\n" : ""), l = e.attrPrefix || "";
            return n += o + "background-color: " + t.utils.getRGBA(i("background-color"), i("background-color-opacity") / 100) + r, 
            n += o + "border-radius: " + s(i("border-radius")) + r, n += o + "border-width: " + s(i("border-width")) + r, 
            n += o + "border-color: " + t.utils.getRGBA(i("border-color"), i("border-color-opacity") / 100) + r, 
            n += o + "font-family: " + i("font-family") + r, n += o + "font-weight: " + i("font-weight") + r, n += o + "font-style: " + i("font-style") + r, 
            n += o + "color: " + t.utils.getRGBA(i("color"), i("color-opacity") / 100) + r, n += o + "font-size: " + s(i("font-size")) + r, 
            n += o + "letter-spacing: " + s(i("letter-spacing")) + r;
        },
        ...
        onSendButtonClick: function() {
            ...
            var i = {
                success: function(t) {
                    ...
                    this.$(".congrats-wrapper .order-info .info-date").text(function(t) {
                        var e = t.split("-");
                        return [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ][e[1] - 1] + " " + parseInt(e[2]) + ", " + parseInt(e[0]);
                    }(t.get("deliver_at"))), this.$(".congrats-wrapper .order-info .info-code").text(t.get("code")), Modernizr.isphone && this.router && this.router.mag && this.router.mag.setScrollPosition({
    ...
    e.now || (e.now = e.webkitNow || e.mozNow || e.msNow || function() {
        ...
        widgetPackEnd: function(e, i) {
            ...
            if (this.isEnabled()) {
                window.performance.mark("end " + t), this.cacheParams(t, Array.prototype.slice.call(arguments, 2));
                var i;
                return e && (i = this.measure(t)), i;
            }
        },
    ...
    t.globalwidgets = {
        ...
        FADE_DURATION: 200,
        getUniqueValue: function(t, e, i) {
            var s = e[this.GLOBAL_UNIQUE_KEY_PREFIX + t] || [], n = _.findWhere(s, {
                pid: i
            });
            return void 0 === (n = n || _.findWhere(s, {
                pid: "default"
            }) || {}).value ? e[t] : n.value;
        },
        ...
        fillUniqueAttributeSets: function(t, e, i) {
            var s = {};
            return e.is_global ? (_(this.GLOBAL_UNIQUE_KEYS).each(function(n) {
                if (_.has(t, n) && void 0 !== t[n]) {
                    var a = e[this.GLOBAL_UNIQUE_KEY_PREFIX + n] || [], o = _.findWhere(a, {
                        pid: i
                    }), r = _.findWhere(a, {
                        pid: "default"
                    });
                    o ? o.value = t[n] : a.push({
                        pid: i,
                        value: t[n]
                    }), r || a.push({
                        pid: "default",
                        value: void 0 === e[n] ? null : e[n]
                    }), s[this.GLOBAL_UNIQUE_KEY_PREFIX + n] = a;
                }
            }.bind(this)), s) : t;
        },
        ensurePageDefRecord: function(t) {
            _(this.GLOBAL_UNIQUE_KEYS).each(function(e) {
                var i = t[this.GLOBAL_UNIQUE_KEY_PREFIX + e] || [];
                _.findWhere(i, {
                    pid: "default"
                }) || i.push({
                    pid: "default",
                    value: void 0 === t[e] ? null : t[e]
                }), t[this.GLOBAL_UNIQUE_KEY_PREFIX + e] = i;
            }.bind(this));
        },
        fillUniqueValues: function(t, e, i) {
            i = i || {}, _.each(t, function(s, n) {
                if (_.contains(this.GLOBAL_UNIQUE_KEYS, n) && (!i.props || _.contains(i.props, n))) {
                    var a = this.getUniqueValue(n, t, e);
                    t[n] = void 0 === a ? s : a;
                }
            }, this);
        },
        show: function(t, e) {
            e = Boolean(e), t.$el.toggleClass("no-transition", e), t.$el.addClass("above-all-fade"), t.$el.hasClass("fade-in") && !e || (t.cancelHide && t.cancelHide(), 
            t.show(), _.delay(function() {
                t.$el.addClass("fade-in");
            }, 50));
        },
        hide: function(e, i) {
            return i = Boolean(i), e.$el.addClass("above-all-fade"), new window.Promise(function(s) {
                e.$el.hasClass("fade-in") || i ? (e.$el.toggleClass("no-transition", i), e.$el.removeClass("fade-in"), 
                i ? (e.hide(), s()) : e.cancelHide = t.utils.waitForTransitionEnd(e.$el, t.globalwidgets.FADE_DURATION, "opacity", function() {
                    e.hide(), s();
                })) : s();
            });
        }
    ...
    t.fn.RMSwipe = function(e) {
        ...
        i.prototype = {
            ...
            onTouchMove: function(e) {
                function i(t, e) {
                    return e ? t > e.max ? e.max + (l.rubberBand ? Math.pow(t - e.max, l.rubberBandForce) : 0) : t : 0;
                }
                var s, n, a = (e = e.originalEvent).touches, o = a[0], r = this.data, l = this.options, c = l.tolerance, d = r && r.constraints, h = this;
                if (!this.animating && r && 1 == a.length && !(e.scale && 1 !== e.scale && l.disableOnScaled || o.identifier != r.id)) {
                    if (!this.started || r.noActionConstraints && !r.isTargetScrollable) {
                        var u = 0, p = "";
                        (n = {
                            up: r.clientY - o.clientY,
                            down: o.clientY - r.clientY,
                            left: r.clientX - o.clientX,
                            right: o.clientX - r.clientX
                        }).up > u && (p = "up", u = n.up), n.down > u && (p = "down", u = n.down), n.left > u && (p = "left", 
                        u = n.left), n.right > u && (p = "right", u = n.right);
                        var g = !1;
                        if (this.started && (g = d.up && n.up > c || d.down && n.down > c || d.left && n.left > c || d.right && n.right > c), 
                        u >= c) if (this.started = !0, d[p] || g) {
                            var m = r.$referenceItem[0].getBoundingClientRect();
                            r.targetX == m.left && r.targetY == m.top || (r.noActionMovement = !0);
                            var f = d.left || d.right ? Math.abs(r.clientX - o.clientX) : 0, v = d.up || d.down ? Math.abs(r.clientY - o.clientY) : 0;
                            r.axis = f > v ? "x" : "y", r.translateInd = "x" == r.axis ? 0 : 1, r.noActionMovement || (r.clientX = o.clientX, 
                            r.clientY = o.clientY, r.$moveItems.addClass("swiping")), r.noActionConstraints = !1, l.onSwipeStart && l.onSwipeStart();
                        } else r.noActionConstraints = !0;
                    }
                    if (this.started && (r.isTargetScrollable ? r.noActionConstraints && !r.noActionMovement || e.preventDefault() : e.preventDefault()), 
                    this.started && !r.noActionConstraints && !r.noActionMovement) {
                        "x" == r.axis ? (s = o.clientX - r.clientX) < 0 ? (p = "left", s = -i(-s, d.left)) : s > 0 && (p = "right", 
                        s = i(s, d.right)) : (s = o.clientY - r.clientY) < 0 ? (p = "up", s = -i(-s, d.up)) : s > 0 && (p = "down", 
                        s = i(s, d.down)), r.$moveItems.each(function(e, i) {
                            var n = r.translate[e], a = n[r.translateInd];
                            l.customMoveCheck && !l.customMoveCheck(t(this), s) || (n[r.translateInd] += s), h.applyTransform(this, r.oldStyle[e], n, 0), 
                            n[r.translateInd] = a;
                        });
                        var _ = r.shift, w = Math.abs(_ - s) / (+new Date() + 1 - r.lastTime);
                        r.shift = s, r.curDir = p, r.velocity = .8 * w + .2 * r.velocity;
                    }
                    r.lastTime = +new Date();
                }
            },
    ...
    t.classes.Share = Backbone.View.extend({
        ...
        getEmbedCode: function(e) {
            ...
            return i = t.common.embedDomainName || window.location.protocol + "//" + window.location.hostname, s = "full" == e.shareMode ? e.mag_num_id : "p" + e.cur_page_num_id, 
            a = ' data-uri="' + s + '" ', a += ' data-width="' + e.size + '" ', (t.common.isDomainViewer || t.common.embedDomainName) && (a += ' data-domain="' + i + '" ', 
            t.common.customDomainProfile || "User" == t.common.embedDomainType || (s = "full" == e.shareMode ? "" : "p" + e.cur_page_num_id)), 
            t.constants.IS_LIVE || (a += ' data-origin="' + t.constants.readymag_embed_host + '" '), n = i + "/" + s, 
            '<a class="rm-mag-embed" href="' + n + '"' + a + ' target="_blank">' + n + "</a>\n" + o;
        }
    });
}(RM), function(t, e) {
    "use strict";
    t.classes.Page = Backbone.View.extend({
        ...
        stop: function(t) {
            ...
            }), this.animations && this.animations.stop(), this;
        },
        getUrl: function() {
        ...
        getWidgetsPacks: function() {
            ...
            var e, i, s = this.visibleWidgetsCoords, n = (s.top + (s.scrollTop || 0)) / s.scale, a = 1 / ((s.bottom + (s.scrollTop || 0)) / s.scale - n), o = [], r = [];
            if (!this.BGWidget || this.BGWidget.rendered || this.BGWidget.loaded || r.push(this.BGWidget), this.fixedWidgets && this.fixedWidgets.length) {
                var l;
                for (e = 0; e < this.fixedWidgets.length; e++) (l = this.fixedWidgets[e]).rendered || l.loaded || l.canRenderImmediately() || r.push(l);
            }
            var c, d, h = [], u = 99999, p = -99999, g = !1;
            for (e = 0; e < this.widgets.length; e++) (i = this.widgets[e]).rendered || i.loaded || "background" == i.type || i.fixed_position || (c = (d = t.classes.Page.getScreenIndex(i, n, a, !0)).index, 
            u = Math.min(d.start, u), p = Math.max(d.end, p), i.screenIndex = c, c !== 1 / 0 && (h[c] = h[c] || [], 
            h[c].push(i)), g = !0);
            if (g) {
                for (h[0] && o.push(h[0]), h[1] && o.push(h[1]), h[-1] && o.push(h[-1]), e = 2; e <= p; e++) h[e] && o.push(h[e]);
                for (e = -2; e >= u; e--) h[e] && o.push(h[e]);
            }
            return r.length && (o.length ? o[0] = r.concat(o[0]) : o = [ r ]), o;
        },
        loadWidgetsPack: function(t, e) {
            function i() {
                a++, r && n == a && e();
            }
            var s, n = 0, a = 0, o = 0, r = !1;
            for (s = 0; s < t.length; s++) {
                var l = t[s];
                l.rendered || l.loaded || l.destroyed || (l.canRenderImmediately() || (n++, l.on("loaded destroyed", i, l)), 
                o++, l.render());
            }
            r = !0, o || e(), n == a && e();
        },
        ...
        createWidgetsForCurrentViewport: function() {
            ...
            }, 0), this.hasFixedWidgets = !!this.fixedWidgets.length, this.$el.removeClass("page-with-fixeds-desktop page-with-fixeds-sticky-or-mobile").toggleClass("page-with-fixeds-desktop", this.hasFixedWidgets && Modernizr.isdesktop).toggleClass("page-with-fixeds-sticky-or-mobile", !(!this.hasFixedWidgets || !this.isStickyVerticalViewer && Modernizr.isdesktop)), 
        ...
        signalOnLoading: function() {
            function t() {
                "background" == this.type && n.destroyLQBackground({
                    animate: !0
                }), s--, this.hasLoadAnimation() && (n._widgetsWithLoadAnimation--, n._widgetsWithLoadAnimation || (n.loadAnimationsReady = !0, 
                n.trigger("loadAnimationsReady"))), s || (n.fireReadyTimeout = setTimeout(i, 200));
            }
            function e() {
                n.videoBGStarted = !0, _.delay(function() {
                    n.trigger("videoBGStarted");
                }, 1300);
            }
            function i() {
                n.loaded = !0, n.trigger("pageLoaded");
            }
            var s = this.widgets.length, n = this;
            _.each(this.widgets, function(e) {
                e.on("loaded", t, e);
            }, this), this.BGWidget && this.hasVideoBG && this.BGWidget.on("videoBGStarted", e, this.BGWidget), 
            0 == s && (this.fireReadyTimeout = setTimeout(i, 200));
        },
        getFontsVariations: function(e, i) {
            var s = t.textutils.getUsedFontsFromWidgetsModels({
                includeCustom: !0,
            ...
            return _.each(s, function(t) {
                for (var e = 0; e < t.used_variations.length; e++) n.push({
        ...
        createLQBackground: function() {
            if (!t.screenshot) {
                ...
                if (this.$fixedBgContainer.css("background-color", "#" + e.color), e.picture && "picture" == e.selectedType && e.picture.poorUrl || e.video && "video" == e.selectedType && e.video.thumbnail_url) {
                    ...
                    if (this.LQBG.$el = $(i({
                        data: e
                    })), this.LQBG.$el.addClass("low-quality").appendTo(this.$fixedBgContainer), "picture" == this.LQBG.selectedType) {
        ...
        fixSafariScroll: function(t) {
            if (Modernizr.safari && Modernizr.isdesktop) {
                0 !== this.$scrollWrapper.scrollTop() && this.$scrollWrapper.scrollTop(0);
            }
        }
    }, {
        getScreenIndex: function(t, e, i, s) {
            var n, a = Math.floor((t.y - e) * i), o = Math.ceil((t.y + t.h - e) * i) - 1;
            return s && t.canRenderImmediately() ? n = 1 / 0 : a <= 0 && o >= 0 ? n = 0 : a > 0 ? n = a : o < 0 && (n = o), 
            {
                start: a,
                end: o,
                index: n
        ...
        setSwipeAction: function() {
            this.pagesSwipe = this.mag.$mag_container.RMSwipe({
                ...
                getCurrentConstraints: _.bind(function(t) {
                    ...
                    return this.mag.isLastPage() && this.hasFinalPage && this.finalPageShown ? e.$moveItems = s : e.$moveItems = s.add(s.prev()).add(s.next()), 
    ...
    t.classes.Widget = Backbone.View.extend({
        ...
        seamlessFontsShow: function(e, i) {
            ...
            if (t.textutils.isFastFontLoadCheckAvailable() && !t.screenshot && !this.insideHotspot && this.hasFontsToLoad()) {
                ...
                t.performance.start(s), this.makeSureFontsLoaded().then(a).catch(o);
            }
        },
        ...
        BackToNormalZ: function() {
            if (this.animationObj) {
                this.animationObj.getAnimationContainer().css("z-index", this.savedAnimationContainerZIndex || this.z);
            }
        ...
        loadVisibleScreenshots: function() {
            if (this.mag.pages && this.mag.pages.length) {
                ...
                this.$(".page").each(function(i) {
                    var s = (n = $(this)).attr("data-src");
                    if (i >= t.min && i <= t.max && s && !e.loadedScreenshots[i]) {
                        var n;
                        (n = $(this)).find(".screenshot").prop("src", s), n.removeAttr("data-src"), e.loadedScreenshots[i] = !0;
                    }
                });
            }
        },
        unloadInvisibleScreenshots: function() {
            if (!this.shown) {
                ...
                this.$(".page").each(function(i) {
                    ...
                    if ((i < t.min || i > t.max) && !s && e.loadedScreenshots[i]) {
                        var n;
                        (n = $(this)).attr("data-src", n.find(".screenshot").prop("src")), n.find(".screenshot").prop("src", e.IMG_STUB), 
                        delete e.loadedScreenshots[i];
                    }
                });
            }
        },
    ...
    t.classes.FinalPage = Backbone.View.extend({
        ...
        events: {
            ...
            "click .dop-container-join .buttons-panel .use-email": "showNativeJoin",
            "click .dop-container-join .native-join .cancel": "hideNativeJoin",
            "click .size-selector": "onSizeSelectorClick"
        },
        initialize: function(t) {
            return _.bindAll(this), _.extend(this, t), this;
    ...
    t.classes.Mag = Backbone.View.extend({
        ...
        render: function() {
            function e() {
                t.textutils.appendFontsCssToDocument({
                    version: n,
                    fonts: a.edit_params && a.edit_params.fonts,
                    typekit_url: a.typekit_url
                });
            }
            if (!this.active) {
                ...
                Modernizr.isdesktop || setTimeout(this.onResize, 1500), this.pages = _(i).chain().sortBy(function(t) {
                    return t.num;
                ...
                var s = this.getPage(this.getPagesCount());
                s && s.markAsLast(), "horizontal" == this.viewOpts.viewertype && this.setPagesTransitions(), t.screenshot || ("horizontal" == this.viewOpts.viewertype && this.viewOpts.arrows && (this.navigation = new t.classes.Navigation({
                    mag: this,
                    router: this.router,
                    $container: this.$el,
                    isPreview: this.isPreview,
                ...
                var n = !this.isPreview && this.model.get("is_published") ? "published" : "edit", a = this;
                return "edit" != n || window.TypekitPreview || Modernizr.isboxversion ? e() : $.getScript(this.TYPEKIT_PREVIEW_API_LINK, function(t, i, s) {
                    e();
                }), this;
            }
        },
        ...
        onPageVisibilityChange: function() {
            if (this.currentPage) if (t.utils.PageVisibilityManager.isPageHidden()) {
        ...
        onDragMove: function(e) {
            ...
            if (!(e.originalEvent.touches.length > 1) && i) {
                if ("horizontal" == this.viewOpts.viewertype) {
                    this.currentPage && this.currentPage.hasFixedWidgets && $(e.target).closest(this.$mag_container).length && !i.$target.length && (i.$target = this.currentPage.$scrollWrapper);
                } else i.$target.length || (i.$target = this.$magScrollContainer);
                if (i.$target.length) {
        ...
        onKeydown: function(e) {
            if ("input" != event.target.tagName.toLowerCase() && ("textarea" != event.target.tagName.toLowerCase() || "copyhack" == event.target.className) && _.isEmpty(t.common.disableShortcuts) && this.isInPresentationMode && !(e.altKey || e.ctrlKey || e.metaKey)) switch (e.which) {
              case 8:
              case 33:
              case 80:
              case 37:
        ...
        onVerticalViewKeyDown: function(t) {
            if (!this.isInPresentationMode && "vertical" === this.viewOpts.viewertype && (t.which === $.keycodes.down || t.which === $.keycodes.up)) {
                ...
                var e = t.which === $.keycodes.down;
                this.arrowKeyLastScrollAt = +new Date();
                var i, s, n = window.innerHeight, a = this.getScroll(), o = this.getScrollPosition(), r = Math.round(n / 4), l = function(t) {
                    return t && t <= r;
                }, c = _.bind(function() {
                    var t = this.magPagesPos[this.currentPage.num];
                    return Math.abs(a - t.y);
                }, this), d = this.currentPage.pageHeight, h = 0 === o && !this.isFirstPage();
                if (e) s = l(i = d - o - n) ? d - o : function(t) {
                    return t > r && t < n;
                }(i) ? i : n, h && this.viewOpts.slidein && (s += c()); else {
                    if (h) {
                        var u = this.magPagesPos[this.currentPage.num - 1];
                        o = u ? u.h : 0;
                    }
                    s = l(i = o - n) || o < n ? -o : -n, h && this.viewOpts.slidein && (s -= this.SCROLL_SNAP - c());
                }
        ...
        setScrollPosition: function(t) {
            if (this.currentPage) {
                var e;
                "vertical" == this.viewOpts.viewertype ? (e = void 0 !== t.offset ? this.magPagesPos[this.currentPage.num].y + t.offset : this.getScroll() + t.delta, 
        ...
        showPage: function(t, e) {
            function i() {
                ...
                e.animation || r || window.requestAnimationFrame(function() {
                    o.$pages_container.removeClass("disable-transitions");
                }), o.continueLoading("page-change-animation"), "vertical" == o.viewOpts.viewertype && "scroll" != e.initiator && o.setScroll(o.magPagesPos[s.num].y), 
            ...
            s && !this.aboveGlobalWidgetsRendered && this.renderAboveGlobalWidgets(s), this.isStickyVerticalViewer ? this.redrawAboveGlobalWidgets() : e.nextPageVisible || "horizontal" === this.viewOpts.viewertype ? this.redrawAboveGlobalWidgets(s, a, e.slideInNextPageScroll || e.nextPageScroll, e.animation) : s ? this.redrawAboveGlobalWidgets(s) : n && this.redrawAboveGlobalWidgets.__debounced(), 
            "vertical" == this.viewOpts.viewertype && (e.animation = !1, s && s.scrollOnVerticalMode(e.pageScroll || 0), 
            s && a && void 0 != e.nextPageScroll && (a.scrollOnVerticalMode(e.nextPageScroll), this.isStickyVerticalViewer || (e.nextPageVisible ? a.start() : a.stop())), 
            s && void 0 != e.nextPageBlackout && this.$pages_blackout.css({
            ...
            if (n) if ("horizontal" == this.viewOpts.viewertype || this.isStickyVerticalViewer) n.stop(); else {
                a == n && e.nextPageVisible || n.stop();
                var l = n && this.getPage(n.num + 1);
                l && !(l == s || l == a && e.nextPageVisible) && l.stop();
            } else e.animation = !1;
            ...
            e.animation && (this.viewOpts.slidein && n && n.num > s.num ? n.waitForAnimationEnd(i) : s.waitForAnimationEnd(i)), 
        ...
        loadPages: function() {
            function t(t, e) {
                t < 0 || t >= n.length || e < 0 || e >= n[t].length || r.push(n[t][e]);
            }
            if (this.pages && this.pages.length) {
                var e = this.getPagesLoadOrder();
                if (e && e.length) {
                    var i, s, n = [], a = [];
                    for (i = 0; i < e.length; i++) {
                        var o = (s = this.pages[e[i]]).getWidgetsPacks();
                        o.length && n.push(o), a = a.concat(s.getImmediatePack());
                    }
                    if (n.length) {
                        var r = [];
                        for (i = 0; i < n.length; i++) {
                            0 == i && t(i, 0), t(i + 1, 0);
                            for (var l = 1; l < n[i].length; l++) t(i, l);
                        }
                        r.unshift(a), this.widgetsPacksLoadQueue = r, this.stopPagesLoad(), this.loadNextWidgetsPack();
                    }
                }
            }
        },
        ...
        getPagesLoadOrder: function() {
            function t(t) {
                t < 0 || t >= n || !o.pages[t].shown || o.pages[t].loaded || a.push(t);
            }
            var e = this.currentPage;
            if (e) {
                var i, s = e.num - 1, n = this.pages.length, a = [], o = this, r = e.num - ("forward" == this.direction ? this.PRELOAD_COUNT.backward : this.PRELOAD_COUNT.forward), l = e.num + ("forward" == this.direction ? this.PRELOAD_COUNT.forward : this.PRELOAD_COUNT.backward);
                if (t(s), "backward" == this.direction) {
                    for (t(s - 1), t(s + 1), i = s - 2; i >= r; i--) t(i);
                    for (i = s + 2; i <= l; i++) t(i);
                } else {
                    for (t(s + 1), t(s - 1), i = s + 2; i <= l; i++) t(i);
                    for (i = s - 2; i >= r; i--) t(i);
                }
                return a;
            }
        ...
        getViewportSetting: function(e, i) {
            i = i || this.viewport;
            return (_.findWhere(t.viewports, {
                name: i
            }) || {})[e];
        },
        log: function() {
        ...
        getWidgetById: function(t, e) {
            ...
            return n ? (s = n.getWidgetById(t)) ? i = window.Promise.resolve(s) : n.loaded || (i = new window.Promise(function(e, i) {
                this.listenToOnce(n, "pageLoaded", function() {
        ...
        renderAboveGlobalWidgets: function(e) {
            ...
            _.each(this.aboveGlobalWidgetsData, function(n) {
                var a = _.find(this.aboveGlobalWidgets, {
                    _id: n._id
                });
                a && (a.destroy(), a.off());
                var o;
                if (n) {
                    ...
                    t.widgets[r.type] && ((o = new t.widgets[r.type](r, e)).$fixedContainer = this.$aboveWidgetsContainer, 
                    o.isValid() && i.push(o));
                }
        ...
        initializeAboveGlobalAnimation: function(e, i) {
            ...
            return _.each(e, function(t) {
                ...
                this.aboveAnimationsReady = !0, this.trigger("aboveAnimationsReady"), s.start();
    ...
    t.classes.ViewerRouter = Backbone.Router.extend({
        ...
        initialize: function() {
            ...
            }.bind(this)), this.isPreview || window.sessionStorage.removeItem("constructorViewport");
        },
    ...
    t.classes.Animations = Backbone.View.extend({
        initialize: function(e) {
            ...
            }, this)), this.animations = [], _.each(i, this.addAnimation), this.start.__debounced = _.debounce(this.start, 300);
        },
        addAnimation: function(t) {
            var e, s = (t = _.isArray(t) ? t : [ t ])[0].animation.type;
            this.page.mag;
            return (Modernizr.isdesktop || "hover" !== s || t[0].animation.trigger) && (e = new i[s]({
                page: this.page,
                widgets: t
            }), this.animations.push(e)), e;
        },
    ...
    var i = {}, s = Backbone.View.extend({
        ...
        initialize: function(t) {
            _.bindAll(this), _.extend(this, t), _.each(this.widgets, _.bind(function(t) {
                t.animationObj = this;
            ...
            this.$el.appendTo(this.$container), this.createAnimationTimeline(), this.onResize({
                updateAll: !0
            });
        },
        createAnimationTimeline: function() {
            this.timeline && this.timeline.destroy(), this.animation = t.animationutils.getNormalizedAnimation(this.widgets[0].animation, this.isFixed, this.isFullwidth, this.page.scale);
            var e, i = !0;
            if (Modernizr.isdesktop) for (e = 0; e < this.animation.steps.length; e++) {
                var s = this.animation.steps[e];
                if (s.use_scale && (0 == e && s.from_scale > 100 || s.scale > 100)) {
                    i = !1;
                    break;
                }
            }
    ...
    i.scroll = s.extend({
        ...
        isReady: function() {
            ...
            if (t.screenshot || this.started || t.utils.PageVisibilityManager.isPageHidden()) e = window.Promise.reject(); else {
                var i = this.widgets[0], s = [], n = new window.Promise(function(t) {
                    window.setTimeout(t, Modernizr.safari ? 1200 : 700);
                }), a = i.loaded ? window.Promise.resolve() : new window.Promise(function(t) {
                    this.listenToOnce(i, "loaded", t);
                }.bind(this));
                if (this.isAbove) {
                    var o = this.page.mag.aboveAnimationsReady ? window.Promise.resolve() : new window.Promise(function(t) {
                        this.listenToOnce(this.page.mag, "aboveAnimationsReady", t);
                    }.bind(this)), r = i.rendered ? window.Promise.resolve() : new window.Promise(function(t) {
                        this.listenToOnce(i, "rendered", t);
                    }.bind(this)), l = i.wasHidden ? new window.Promise(function(t) {
                        this.listenToOnce(i, "shown", t);
                    }.bind(this)) : window.Promise.resolve();
                    s = this.startWhenInView ? [ r, l, a, n ] : [ o, r, l, a, n ];
                } else {
                    var c = this.page.started ? window.Promise.resolve() : new window.Promise(function(t) {
                        this.listenToOnce(this.page, "started", t);
                    }.bind(this)), d = this.page.loadAnimationsReady ? window.Promise.resolve() : new window.Promise(function(t) {
                        this.listenToOnce(this.page, "loadAnimationsReady", t);
                    }.bind(this)), h = this.page.isCurrent() ? window.Promise.resolve() : new window.Promise(function(t) {
                    ...
                    }.bind(this)), g = window.Promise.race([ u, p ]);
                    s = this.startWhenInView ? [ c, h, g, n ] : [ d, c, n ];
                }
    ...
    t.classes.ShapeSVG = function() {}, t.classes.ShapeSVG.prototype = {
        ...
        generateShapeSVG: function(t, e, i, s, n) {
            ...
            var o, r = 1e5, l = e.get("bg_color") || e.viewport_default && e.viewport_default.bg_color, c = this.getRGBA(l, e.get("bg_opacity")), d = this.getRGBA(e.get("color"), e.get("opacity"));
            if ("ellipse" == (n = "hotspot" === e.get("type") ? n || e.get("pin_type") : n || e.get("tp"))) {
                var h = i / 2, u = s / 2, p = e.get("borders");
                o = a("ellipse", {
                    cx: h,
                    cy: u,
                    rx: h,
                    ry: u
                }, c, d, p = Math.min(p, h, u), e.id + "_" + t, e.get("opacity"));
            }
            if ("rectangle" == n || "polygon" == n) {
                "hotspot" === e.get("type") && (d = c = "rgba(0, 0, 0, 0)");
                var g = "rectangle" == n ? 4 : e.get("sides"), m = (p = e.get("borders"), e.get("radius") || 0), f = function(t, e, i, s) {
                    for (var n, a, o, l = 2 * Math.PI / t, c = Math.PI / 2 - (t % 2 == 1 ? 0 : l / 2), d = [], h = 999999, u = -999999, p = 999999, g = -999999, m = 0; m < t; m++) n = c + m * l, 
                    a = .5 + .5 * Math.cos(n), o = .5 - .5 * Math.sin(n), d.push({
                        x: a,
                        y: o
                    }), a < h && (h = a), a > u && (u = a), o < p && (p = o), o > g && (g = o);
                    for (m = 0; m < t; m++) d[m].x = (d[m].x - h) * (e / (u - h)), d[m].y = (d[m].y - p) * (i / (g - p)), 
                    d[m].x = Math.round(d[m].x * r) / r, d[m].y = Math.round(d[m].y * r) / r;
                    return d;
                }(g, i, s), v = function(t, e, i, s, n, a) {
                    if (!t) return {};
                    if (e <= 1e-4) return {};
                    var o = [], l = t.length;
                    e = Math.min(e, i / 2);
                    for (var c = 0; c < l; c++) {
                        ...
                        d = g.x + v * e, h = g.y + _ * e, u = m.x - v * e, p = m.y - _ * e, d = Math.round(d * r) / r, h = Math.round(h * r) / r, 
                        u = Math.round(u * r) / r, p = Math.round(p * r) / r, o.push({
                            x: d,
                            y: h
                        }), o.push({
                            x: u,
                ...
                o = a("path", {
                    path: _ = function(t, e, i) {
                        ...
                        for (var s = t.length, n = "", a = 0; a < s; a++) {
                            ...
                            if (n += 0 == a ? "M" : "L", e) {
                                n += e[o].x + " " + e[o].y + " ";
                                var l = e[o].x - e[r].x, c = e[o].y - e[r].y, d = 1 / ((l * l + c * c) / 4) - 1 / (i * i), h = Math.sqrt(1 / d);
                                n += "A" + h + " " + h + " 0 0 0 " + e[r].x + " " + e[r].y + " ";
                            } else n += t[a].x + " " + t[a].y + " ";
                        }
                        return n + " Z ";
                    }(f, v.points, v.radius)
                }, c, d, p, e.id + "_" + t, e.get("opacity"));
            }
            if ("line" == n) {
                p = e.get("weight"), u = Math.round(s / 2) + (p % 2 == 1 ? .5 : 0);
                var _ = "", w = [ 13 * p / 3, 2 * p / 3 ].join(" "), y = p > 1 ? [ .001, 5 * p / 3 ].join(" ") : [ 1, 2 ].join(" "), b = "dotted" == e.get("stroke") ? p / 2 : 0;
                if (_ = "M" + b + " " + u + " L" + i + " " + u, "solid" == e.get("stroke") && (o = '<path d="' + _ + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>'), 
                "double" == e.get("stroke")) {
                    o = '<path d="' + ("M" + b + " " + (u - p) + " L" + i + " " + (u - p)) + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>', 
                    o += '<path d="' + ("M" + b + " " + (u + p) + " L" + i + " " + (u + p)) + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>';
                }
                "dotted" == e.get("stroke") && (o = '<path d="' + _ + '" stroke-linecap="round" stroke-dasharray="' + y + '" style=" fill:none; stroke:' + c + ";stroke-width:" + p + '"/>'), 
                "dashed" == e.get("stroke") && (o = '<path d="' + _ + '" stroke-dasharray="' + w + '" style=" fill:none; stroke:' + c + ";stroke-width:" + p + '"/>');
            }
            if ("icon" == n) {
                ...
                return x.css({
                    width: "100%",
                    height: "100%"
                }), c = this.getRGBA(l, 1), x.find("*:not(.fixed-color)").each(function() {
                    var t = $(this);
                    t.css({
                        fill: "",
                        "fill-opacity": ""
                    }), t.get(0).removeAttribute("fill"), t.get(0).removeAttribute("fill-opacity");
                }), x.get(0).setAttribute("fill", c), x.get(0).setAttribute("fill-opacity", e.get("bg_opacity")), x;
            }
            return '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="' + i + 'px" height="' + s + 'px">' + o + "</svg>";
        },
        getRGBA: function(t, e) {
            if (0 == e) return "none";
    ...
    var i = Backbone.View.extend({
        ...
        defaultCover: "//d1id5eheivyv24.cloudfront.net/2017-12-15-1c2205f963b4ced2/img/common/audio-player/cover.png",
        initialize: function(e, i, s, n) {
    ...
    t.classes.SlideshowPlayer = Backbone.View.extend({
        ...
        getPicsTransitionTime: function() {
            if (!t.screenshot) {
                ...
                i = Math.round(this.params.w * s), e = i >= 768 ? 550 : i >= 667 ? 520 : i >= 568 ? 490 : i >= 480 ? 470 : 400;
            }
        },
        setImageSize: function(t, e, i, s, n) {
            if (!e || !i) return t ? "cover" : "contain";
            var a, o;
            return t ? (s / n > e / i ? (a = s + 2, o = Math.round(a * i / e)) : (o = n + 2, a = Math.round(o * e / i)), 
            a + "px " + o + "px") : e < s && i < n ? e + "px " + i + "px" : (s / n > e / i ? (o = n + 2, a = Math.round(o * e / i)) : (a = s + 2, 
            o = Math.round(a * i / e)), a + "px " + o + "px");
        },
        ...
        moveToImage: function(t, i, s) {
            function n() {
                if (a.each(function(t) {
                    var e = $(this);
                    (t < h || t > u) && e.addClass("hidden");
                }), o.data("first-child") && d.$images_wrapper.children().last().removeClass("hidden"), o.data("last-child") && d.$images_wrapper.children().first().removeClass("hidden"), 
                i || d.initialRender || window.requestAnimationFrame(function() {
                    d.$images_wrapper.addClass("enable-transitions");
                }), d.trigger("currentImageChanged", t, i, s), d.handleCounters && !d.initialRender) {
                    var n = d.$counters_container.children('[data-id="' + t + '"]');
                    d.$counters_container.children(".active").removeClass("active"), n.addClass("active");
                    var r = n.get(0).offsetLeft, l = d.$counters.find(".items-wrapper").width(), c = e;
                    r + 2 * d.COUNTER_WIDTH - d.$counters.find(".items-wrapper").scrollLeft() > l ? c = r + 2 * d.COUNTER_WIDTH - l : r - d.COUNTER_WIDTH - d.$counters.find(".items-wrapper").scrollLeft() < 0 && (c = r - d.COUNTER_WIDTH), 
                    c != e && (i ? d.$counters.find(".items-wrapper").stop().animate({
                        scrollLeft: c
                    }, 200) : d.$counters.find(".items-wrapper").scrollLeft(c));
                }
                if (d.handleThumbnails && !d.initialRender) {
                    var p = d.$thumbnails_container.children('[data-id="' + t + '"]');
                    d.$thumbnails_container.children(".active").removeClass("active"), p.addClass("active");
                    r = p.position().left, l = d.$thumbnails.find(".items-wrapper").width(), c = e;
                    r + 2 * (d.THUMBNAIL_WIDTH + d.THUMBNAIL_PADDING) - d.THUMBNAIL_PADDING / 2 - d.$thumbnails.find(".items-wrapper").scrollLeft() > l ? c = r + 2 * (d.THUMBNAIL_WIDTH + d.THUMBNAIL_PADDING) - d.THUMBNAIL_PADDING / 2 - l : l > 2 * (d.THUMBNAIL_WIDTH + d.THUMBNAIL_PADDING) && r - d.THUMBNAIL_WIDTH - d.THUMBNAIL_PADDING / 2 - d.$thumbnails.find(".items-wrapper").scrollLeft() < 0 && (c = r - d.THUMBNAIL_WIDTH - d.THUMBNAIL_PADDING / 2);
                }
                if (c != e && (i ? d.$thumbnails.find(".items-wrapper").stop().animate({
                    scrollLeft: c
                }, 200) : d.$thumbnails.find(".items-wrapper").scrollLeft(c)), d.model && "constructor" == d.environment) {
                    var g = d.model.get("pictures"), m = _.findWhere(g, {
                        id: d.currentImageID
                    });
                    m ? d.$captions.find(".caption").val(m.text).attr("data-id", d.currentImageID) : d.$captions.find(".caption").val("").attr("data-id", "");
                } else "theme_captions" == d.params.current_theme && "viewer" == d.environment && (i ? d.$captions.find('.caption-wrapper[data-id="' + d.currentImageID + '"]').stop().fadeIn(200).siblings().stop().fadeOut(200) : (d.$captions.find(".caption-wrapper").stop().css({
                    display: "none"
                }), d.$captions.find('.caption-wrapper[data-id="' + d.currentImageID + '"]').stop().css({
                    display: "block"
                })));
                d.preloadImages(), d.preloadThumbImages();
            }
            if (t) {
                var a = this.$images_wrapper.children(".image"), o = a.filter('[data-id="' + t + '"]'), r = a.index(o), l = _.clone(this.currentPic), c = r, d = this;
                if (o.length && -1 != r) {
                    this.currentImageID = t, this.currentPic.$el = o, this.currentPic.num = r, "switch-to-image" == s && (this.disableAutoplayOnUserInteraction = !0, 
                    this.stopAutoplay()), this.$images_wrapper.toggleClass("enable-transitions", i), this.resetWaitForAnimationEnd(), 
                    i && l.$el && this.waitForAnimationEnd(l.$el, n), this.direction = !l.$el || !l.$el.length || l.num < c ? "forward" : "backward", 
                    o.data("first-child") && l.$el && l.$el.length && l.$el.data("last-child") ? this.direction = "forward" : o.data("last-child") && l.$el && l.$el.length && l.$el.data("first-child") && (this.direction = "backward");
                    var h = c - ("forward" == this.direction ? this.PREDISPLAY_COUNT.backward : this.PREDISPLAY_COUNT.forward), u = c + ("forward" == this.direction ? this.PREDISPLAY_COUNT.forward : this.PREDISPLAY_COUNT.backward);
                    a.each(function(t) {
                        var e = $(this);
                        t < c ? d.setPicPosition(e, "prev", t + 1 === c) : t > c ? d.setPicPosition(e, "next", t - 1 === c) : d.setPicPosition(e, "center", t === c), 
                        t >= h && t <= u && e.removeClass("hidden");
                    }), d.$images.find(".counters-text-current").html(r + 1), !i && n();
                }
            }
        },
        ...
        preloadImages: function() {
            function e(t) {
                if (a.isFullscreenMode && t.data("orig-src")) {
                    var e = new Image();
                    e.onload = function() {
                        t.css({
                ...
                t.attr("data-src") && (a.preloadImagesList.push({
                    url: t.attr("data-src")
                }), t.css({
            ...
            if ("viewer" == this.environment) {
                var i = this.$images_wrapper.children('[data-id="' + this.currentImageID + '"]');
                if (i.length) {
                    var s = i.prev();
                    s.length || (s = this.$images_wrapper.children(":last"));
                    var n = i.next();
                    n.length || (n = this.$images_wrapper.children(":first"));
                    var a = this;
                    e(i), t.screenshot || (e(s), e(n));
                }
            }
        },
    ...
    t.classes.ButtonWidget = Backbone.View.extend({
        ...
        applyTransition: function() {
            if ("viewer" === this.environment && !Modernizr.touch) {
                this.model.transition && this.$button.addClass("transition");
            }
        },
    ...
    t.classes.FormWidget = Backbone.View.extend({
        ...
        DROPDOWN_TRIANGLE_SVG: '<svg class="form-dropdown-triangle" xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 11 11"><polygon points="2 4 9 4 5.5 8 "/></svg>',
        DROPDOWN_TRIANGLE_OPACITY_MULTIPLIER: .4,
        initialize: function(e) {
        ...
        render: function(t) {
            ...
            for (var e, i, s = this.data, n = s.fields, a = $("<div>"), o = 0; o < n.length; o++) {
                ...
                if (l.appendTo(a), "dropdown" == r.tp && r.items) {
                    var h = $("<select>"), u = $(this.DROPDOWN_TRIANGLE_SVG);
        ...
        getTotalInputsHeight: function(t, e) {
            return _.reduce(t, function(t, i) {
                if ("text" === i.tp) {
                    return t + this.getExtraTextareaDimensions(i.rows, e).height;
                }
                return t + e;
            }.bind(this), 0);
        },
        ...
        showInputPlaceholdersAsValues: function(t) {
            this.$inputs.each(function(e, i) {
                ...
                s.val(t ? s.attr("placeholder") : "");
            });
        },
        applyInputsStyle: function(t, e) {
            e = e || {};
            var i, s = this.data, n = (s.fields, _.clone(s["style-" + s.style + "-fields"]));
            "underlined" == s.style ? (e.invalid && (n["underline-color"] = this.INVALID_COLOR, n["underline-opacity"] = 100, 
            n["underline-width"] = n["underline-width"] || this.INVALID_BORDER_WIDTH), i = {
                "background-color": "transparent",
                "border-radius": 0,
                "box-shadow": "inset 0 " + -n["underline-width"] + "px 0 0 " + this.getRgba(n["underline-color"], n["underline-opacity"])
            }) : (e.invalid && (n["border-color"] = this.INVALID_COLOR, n["border-opacity"] = 100, n["border-width"] = n["border-width"] || this.INVALID_BORDER_WIDTH), 
            i = {
            ...
            var a = {
                ...
                "margin-bottom": n["underline-width"] ? n["underline-width"] + "px" : 0
            };
            t.css(i).find(".js-input, select").css(a), t.find(".js-add-line, .js-remove-line").css({
                "font-size": n["font-size"]
            }), t.find(".form-dropdown-triangle").each(function(t, e) {
                var i = $(e), s = i.parent(), a = s.find(".js-input"), o = a.position().top, r = s.height() - a.height() - o;
                i.css({
                    fill: this.getRgba(n["text-color"], n["text-opacity"] * this.DROPDOWN_TRIANGLE_OPACITY_MULTIPLIER),
                    top: o,
                    bottom: r
                });
            }.bind(this));
        ...
        onInputHoverOut: function(t) {
            var e = this.data, i = _.clone(e["style-" + e.style + "-fields"]);
            $(t.currentTarget).find(".form-dropdown-triangle").css("fill", this.getRgba(i["text-color"], i["text-opacity"] * this.DROPDOWN_TRIANGLE_OPACITY_MULTIPLIER));
        },
    ...
    t.widgets.text = t.classes.Widget.extend({
        ...
        render: function() {
            ...
            return this.$el.find("a").each(function() {
                var e = $(this), i = e.attr("data-pid"), s = i;
                /^back\sto\stop$/i.test(e.attr("href")) && (s = n.page._id);
                var a = n.page.mag.matchSameDomainLink(e.attr("href"));
                if ((a == e.attr("href") || s) && (a = void 0), s = s || a) {
                    var o = n.page.mag.getPageNum(s), r = o && n.page.mag.getPageUri ? "/" + n.page.mag.getPageUri(s) : "javascript:void(0)";
                    o ? e.attr("href", r).addClass("maglink").attr("target", "") : e.removeAttr("href"), s == n.page._id && (e.addClass("back-to-top"), 
                    ...
                    var l = e.attr("href").match(n.mailchimpMatcher)[1];
                    e.attr("href", "javascript:void(0)").attr("data-mailchimp", l).addClass("mailchimp-link"), t.initutils.initMailchimpAPI();
                } else if (n.shareRegexp.test(e.attr("href"))) {
                    var c = e.attr("href").match(n.shareRegexp);
                    e.attr("href", "javascript:void(0)").attr("data-share-provider", c[1]).attr("data-share-type", c[2]).addClass("share-link");
                } else if (n.anchorRegexp.test(e.attr("href"))) {
                    e.attr("href", "javascript:void(0)").addClass("anchor-link");
                    var d = e.attr("data-page-uri"), h = _.findWhere(n.mag.pages, {
                        _id: d
                    }) || n.page;
                    e.attr("data-page-uri", h.uri || h.num);
    ...
    t.widgets.picture = t.classes.Widget.extend({
        ...
        getPictureUrl: function() {
            ...
            var e = Modernizr.retina || t.scale.isOn(this.page.scale) ? this.picture.final2xUrl || this.picture.finalUrl : this.picture.finalUrl;
    ...
    t.widgets.twitter = t.classes.Widget.extend({
        ...
        render: function() {
            ...
            var e, i;
            return this.current_type ? ("mag" === (i = this[this.current_type]).use_own_url ? i.url = this.page.mag.getUrl() : "page" !== i.use_own_url && i.url || (i.url = this.page.getUrl()), 
    ...
    t.widgets.facebook = t.classes.Widget.extend({
        ...
        start: function() {
            ...
            var e, i, s = this;
            return this.current_type ? (i = this[this.current_type], i.w = this.w, i.h = this.h, "mag" === i.use_own_url ? i.url = this.page.mag.getUrl() : "page" !== i.use_own_url && i.url || (i.url = this.page.getUrl()), 
...
window.onYouTubeIframeAPIReady = function() {
    ...
    t.widgets.iframe = t.classes.Widget.extend({
        render: function() {
            ...
            var t = this.getPluginClass();
            return t ? (this.plugin = new t({
                widget: this
    ...
    t.widgets.button = t.classes.Widget.extend({
        ...
        render: function() {
            ...
            var e;
            return this.makeBox("widget-button"), this.hasHoverAnimation && this.$el.addClass("has-onhover-animation"), 
        ...
        preloadIconImage: function(t) {
            ...
            if ("icon" === e || "text_and_icon" === e) {
                if (t.default) {
                    new Image().src = Modernizr.retina ? this.icon_raster2xUrl || this.icon_rasterUrl : this.icon_rasterUrl;
                }
                if (t.hover) {
                    new Image().src = Modernizr.retina ? this["hover-icon_raster2xUrl"] || this["hover-icon_rasterUrl"] : this["hover-icon_rasterUrl"];
                }
            }
        },
    ...
    t.widgets.hotspot = t.classes.Widget.extend(t.classes.ShapeSVG.prototype).extend({
        ...
        applyTipPosition: function() {
            function t(t) {
                ...
                switch (t) {
                  case "top":
                    e = s.top - n.h / 2 - o - a.h, r = s.bottom + n.h / 2 + o, l = s.left - a.w / 2, i = s.right - a.w / 2;
                    break;

                  case "right":
                    e = s.top - a.h / 2, r = s.bottom - a.h / 2, l = s.left + n.w / 2 + o, i = s.right - n.w / 2 - o - a.w;
                    break;

                  case "bottom":
                    e = s.bottom + n.h / 2 + o, r = s.bottom - n.h / 2 - o - a.h, l = s.left - a.w / 2, i = s.right - a.w / 2;
                    break;

                  case "left":
                    e = s.top - a.h / 2, r = s.bottom - a.h / 2, l = s.left - n.w / 2 - o - a.w, i = s.right + n.w / 2 + o;
                }
                return {
                    top: e,
                    left: l,
            ...
            var e, i, s = this.calcDistsToPageVisibleBounds(), n = {
                w: this.w,
                h: this.h
            }, a = {
                w: this.$tip.width(),
                h: this.$tip.height()
            }, o = this.hotspotWidget.TIP_GAP, r = this.tip_pos, l = _.pick(this, "w", "h", "tip_w", "tip_h", "tip_pos"), c = !1, d = !1;
            r = function(e) {
                var i, s = e, n = -1 / 0, a = !1;
                return _.each([ "top", "right", "bottom", "left" ], function(o) {
                    if (!a) {
                        var r = t(o);
                        i = _.min(r), o == e && r[o] > 0 ? (s = o, a = !0) : i > n && r[o] >= 0 && (n = i, s = o);
                    }
                }), s;
            }(this.tip_pos), l.tip_pos = r, i = this.hotspotWidget.apply_tip_position(l), e = t(r), _.each(e, function(t, e) {
                if (t < 0) switch (e) {
                  case "top":
                    i.top -= t - this.EDGE_GAP, c = !0;
                    break;

                  case "bottom":
                    c || (i.top += t - this.EDGE_GAP);
                    break;

                  case "left":
                    i.left -= t - this.EDGE_GAP, d = !0;
                    break;

                  case "right":
                    d || (i.left += t - this.EDGE_GAP);
                }
            }.bind(this)), this.$tip.css(i);
        },
    ...
    t.models.Mag = t.models.SocketModel.extend({
        ...
        onAdd: function(t, e) {
            this.pages.add(t);
            var i;
            (i = _.clone(this.get("pids"))).push(t.id), i = _(i).chain().uniq().compact().value(), this.set({
                pids: i
            }, e);
        },
        ...
        loadActualScreenshot: function(t) {
            if (this._actualScreenshots = this._actualScreenshots || {}, !this._actualScreenshots[t]) {
                this._actualScreenshots[t] = !0;
        ...
        fetchLastChanged: function(t) {
            this.fetch({
                ...
                noSocketUpdate: !0,
                success: _.bind(function(e) {
                    if (this.previousAttributes() && this.previousAttributes().last_changed) {
                        var i = new Date(this.previousAttributes().last_changed);
                        t(i.getTime() + 3e5 < new Date(this.get("last_changed")).getTime() ? {
                            wasChanged: !0
                        } : {
                            wasChanged: !1
                        });
    ...
    t.classes.MagPassword = Backbone.View.extend({
        ...
        render: function(e) {
            ...
            }).prop("src", "//d1id5eheivyv24.cloudfront.net/2017-12-15-1c2205f963b4ced2/img/viewer/mag-password/bg.jpg");
        },
